...
let array_to_slice const =
  {
    ...
    typ = Krml.Helpers.fold_arrow [ TBuf (mk_arr (TBound 0) (CgVar 0), const) ] (mk_slice (TBound 0));
    n_type_args = 1;
    cg_args = [ TInt SizeT ];
    arg_names = [ "a" ];
  }
...
let array_to_subslice const =
  {
    ...
    typ =
      Krml.Helpers.fold_arrow
        [ TBuf (mk_arr (TBound 2) (CgVar 0), const); mk_range (TInt SizeT) ]
        (mk_slice (TBound 2));
    n_type_args = 3;
    cg_args = [ TInt SizeT ];
    arg_names = [ "a"; "r" ];
...
let array_to_subslice_to const =
  {
    ...
    typ =
      Krml.Helpers.fold_arrow
        [ TBuf (mk_arr (TBound 2) (CgVar 0), const); mk_range_to (TInt SizeT) ]
        (mk_slice (TBound 2));
    n_type_args = 3;
    cg_args = [ TInt SizeT ];
    arg_names = [ "a"; "r" ];
...
let array_to_subslice_from const =
  {
    ...
    typ =
      Krml.Helpers.fold_arrow
        [ TBuf (mk_arr (TBound 2) (CgVar 0), const); mk_range_from (TInt SizeT) ]
        (mk_slice (TBound 2));
    n_type_args = 3;
    cg_args = [ TInt SizeT ];
    arg_names = [ "a"; "r" ];

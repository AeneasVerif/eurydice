...
static inline Eurydice_int128_t Eurydice_u128_sub(Eurydice_int128_t lhs, Eurydice_int128_t rhs) {
  uint64_t lo = lhs.lo - rhs.lo;
  uint64_t borrow = (lhs.lo < rhs.lo) ? 1 : 0;
  return (Eurydice_int128_t){.hi = lhs.hi - rhs.hi - borrow, .lo = lo};
}
...
static inline Eurydice_int128_t Eurydice_i128_neg(Eurydice_int128_t x) {
  return *(Eurydice_int128_t*)&Eurydice_u128_neg(*(Eurydice_uint128_t*)&x);
}
...
static inline Eurydice_int128_t Eurydice_i128_mul(Eurydice_int128_t a, Eurydice_int128_t b) {
  ...
  return sign ? *(Eurydice_int128_t*)&Eurydice_u128_neg(abs_result) 
              : *(Eurydice_int128_t*)&abs_result;
}
...
Eurydice_int128_t Eurydice_i128_div(Eurydice_int128_t a, Eurydice_int128_t b) {
  ...
  Eurydice_int128_t result = sign ? *(Eurydice_int128_t*)&Eurydice_u128_neg(abs_quot) 
                                : *(Eurydice_int128_t*)&abs_quot;
  if (a.hi >> 63 && !Eurydice_u128_is_zero(*(Eurydice_uint128_t*)&result)) 
    result = Eurydice_i128_sub(result, Eurydice_i128_from_i64(1));
  return result;
}
static inline
Eurydice_uint128_t Eurydice_u128_bor(Eurydice_uint128_t lhs, Eurydice_uint128_t rhs) {

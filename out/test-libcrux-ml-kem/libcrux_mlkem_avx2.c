...
serialize_uncompressed_ring_element_52(const Eurydice_arr_13 *re)
{
  ...
  for (size_t i = (size_t)0U; i < LIBCRUX_ML_KEM_POLYNOMIAL_VECTORS_IN_RING_ELEMENT; i++)
  {
    ...
    Eurydice_slice_copy(Eurydice_array_to_subslice_mut_d45(&serialized,
        (
          KRML_CLITERAL(core_ops_range_Range_87){
            .start = (size_t)24U * i0,
...
)
{
  serialize_vector_e3(t_as_ntt,
    Eurydice_array_to_subslice_mut_d413(serialized,
      (
        KRML_CLITERAL(core_ops_range_Range_87){
          .start = (size_t)0U,
...
- K= 3
*/
static KRML_MUSTINLINE Eurydice_arr_600 sample_from_xof_7e1(const Eurydice_arr_81 *seeds)
{
...
- K= 3
*/
static KRML_MUSTINLINE Eurydice_arr_600 sample_from_xof_281(const Eurydice_arr_81 *seeds)
{
  Eurydice_arr_eb0 sampled_coefficients = { .data = { 0U } };
  Eurydice_arr_b1
  out = { .data = { { .data = { 0U } }, { .data = { 0U } }, { .data = { 0U } } } };
...
bool libcrux_ml_kem_ind_cca_validate_public_key_ce(const Eurydice_arr_03 *public_key)
{
  ...
  public_key_serialized =
    serialize_public_key_ce(&deserialized_pk,
      Eurydice_array_to_subslice_from_shared_5f(public_key,
        libcrux_ml_kem_constants_ranked_bytes_per_ring_element((size_t)2U)));
...
static KRML_MUSTINLINE Eurydice_arr_e7 compress_then_serialize_11_fe(const Eurydice_arr_13 *re)
{
  ...
  for (size_t i = (size_t)0U; i < LIBCRUX_ML_KEM_POLYNOMIAL_VECTORS_IN_RING_ELEMENT; i++)
  {
    ...
    Eurydice_slice_copy(Eurydice_array_to_subslice_mut_d419(&serialized,
        (
          KRML_CLITERAL(core_ops_range_Range_87){
            .start = (size_t)22U * i0,
...
static KRML_MUSTINLINE Eurydice_arr_b0 compress_then_serialize_10_03(const Eurydice_arr_13 *re)
{
  ...
  for (size_t i = (size_t)0U; i < LIBCRUX_ML_KEM_POLYNOMIAL_VECTORS_IN_RING_ELEMENT; i++)
  {
    ...
    Eurydice_slice_copy(Eurydice_array_to_subslice_mut_d410(&serialized,
        (
          KRML_CLITERAL(core_ops_range_Range_87){
            .start = (size_t)20U * i0,
...
)
{
  ...
  uu____0 =
    encrypt_c1_780(randomness,
      &public_key->A,
      Eurydice_array_to_subslice_mut_d417(&ciphertext,
...
)
{
  ...
  encrypt_c2_15(&public_key->t_as_ntt,
    ...
    &error_2,
    message,
    Eurydice_array_to_subslice_from_mut_5f4(&ciphertext, (size_t)960U));
  return ciphertext;
}
...
)
{
  ...
  uu____0 =
    encrypt_c1_78(randomness,
      &public_key->A,
      Eurydice_array_to_subslice_mut_d411(&ciphertext,
...
)
{
  ...
  deserialize_ring_elements_reduced_16(uu____0,
    &unpacked_public_key->ind_cpa_public_key.t_as_ntt);
  unpacked_public_key->ind_cpa_public_key.seed_for_A =
    libcrux_ml_kem_utils_into_padded_array_ce(Eurydice_array_to_subslice_from_shared_5f(public_key,
        (size_t)768U));
  Eurydice_arr_e2 *uu____2 = &unpacked_public_key->ind_cpa_public_key.A;
  /* original Rust expression is not an lvalue in C */
  Eurydice_arr_31
  lvalue =
    libcrux_ml_kem_utils_into_padded_array_de(Eurydice_array_to_subslice_from_shared_5f(public_key,
        (size_t)768U));

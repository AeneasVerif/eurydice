...
void we_need_charon_monomorphization_supply_ref(Eurydice_dst_ref_mut_fc s)
{
...
- N= 3
*/
static Eurydice_dst_ref_mut_fc array_to_slice_mut_d4(Eurydice_arr_8d *a)
{
...
void we_need_charon_monomorphization_main(void)
{
  ...
  we_need_charon_monomorphization_supply_ref(array_to_slice_mut_d4(&lvalue));
}

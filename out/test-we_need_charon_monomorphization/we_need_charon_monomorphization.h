/* 
  ...
  KaRaMeL invocation: ./eurydice --output out/test-we_need_charon_monomorphization test/we_need_charon_monomorphization.llbc --log Phase3.3
  F* version: <unknown>
  KaRaMeL version: 3bad1c74
 */

  ...
  KRML_MAYBE_FOR4(i0,
    ...
    for (size_t i = (size_t)0U; i < (size_t)504U / (size_t)24U; i++)
    {
      ...
      if (sampled_coefficients->data[i1] < LIBCRUX_ML_KEM_CONSTANTS_COEFFICIENTS_IN_RING_ELEMENT)
      {
        size_t
        sampled =
          libcrux_ml_kem_vector_portable_rej_sample_44(Eurydice_array_to_subslice_mut_d49(&randomness->data[i1],
              (
                KRML_CLITERAL(core_ops_range_Range_87){
                  .start = r * (size_t)24U,
  ...
  KRML_MAYBE_FOR4(i0,
    ...
    for (size_t i = (size_t)0U; i < (size_t)168U / (size_t)24U; i++)
    {
      ...
      if (sampled_coefficients->data[i1] < LIBCRUX_ML_KEM_CONSTANTS_COEFFICIENTS_IN_RING_ELEMENT)
      {
        size_t
        sampled =
          libcrux_ml_kem_vector_portable_rej_sample_44(Eurydice_array_to_subslice_mut_d41(&randomness->data[i1],
              (
                KRML_CLITERAL(core_ops_range_Range_87){
                  .start = r * (size_t)24U,
                  .end = r * (size_t)24U + (size_t)24U
...
- K= 4
*/
static Eurydice_arr_d20 call_mut_ae_ee(void **_)
{
  Eurydice_arr_d20 arr_struct;
  KRML_MAYBE_FOR4(i,
    (size_t)0U,
...
- K= 3
*/
static Eurydice_arr_bb call_mut_ae_68(void **_)
{
  Eurydice_arr_bb arr_struct;
  KRML_MAYBE_FOR3(i,
    (size_t)0U,

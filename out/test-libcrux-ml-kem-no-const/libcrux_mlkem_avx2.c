...
serialize_vector_e3(Eurydice_arr_600 *key, Eurydice_mut_borrow_slice_u8 out)
{
  KRML_MAYBE_FOR3(i,
    (size_t)0U,
    (size_t)3U,
...
)
{
  ...
  Eurydice_slice_copy(Eurydice_array_to_subslice_from_mut_5f(serialized,
...
serialize_public_key_79(Eurydice_arr_600 *t_as_ntt, Eurydice_mut_borrow_slice_u8 seed_for_a)
{
...
compute_As_plus_e_e3(
  Eurydice_arr_600 *t_as_ntt,
  Eurydice_arr_601 *matrix_A,
  Eurydice_arr_600 *s_as_ntt,
  Eurydice_arr_600 *error_as_ntt
)
{
  KRML_MAYBE_FOR3(i,
    (size_t)0U,
    ...
    (size_t)1U,
    size_t i0 = i;
    Eurydice_arr_600 *row = &matrix_A->data[i0];
  ...
  KRML_MAYBE_FOR3(i0,
    ...
    for (size_t i = (size_t)0U; i < (size_t)168U / (size_t)24U; i++)
    {
      ...
      if (sampled_coefficients->data[i1] < LIBCRUX_ML_KEM_CONSTANTS_COEFFICIENTS_IN_RING_ELEMENT)
      {
        size_t
        sampled =
          libcrux_ml_kem_vector_avx2_rej_sample_14(Eurydice_array_to_subslice_mut_d43(&randomness->data[i1],
              (
                KRML_CLITERAL(core_ops_range_Range_87){
                  .start = r * (size_t)24U,
  ...
  KRML_MAYBE_FOR3(i0,
    ...
    for (size_t i = (size_t)0U; i < (size_t)504U / (size_t)24U; i++)
    {
      ...
      if (sampled_coefficients->data[i1] < LIBCRUX_ML_KEM_CONSTANTS_COEFFICIENTS_IN_RING_ELEMENT)
      {
        size_t
        sampled =
          libcrux_ml_kem_vector_avx2_rej_sample_14(Eurydice_array_to_subslice_mut_d410(&randomness->data[i1],
              (
                KRML_CLITERAL(core_ops_range_Range_87){
                  .start = r * (size_t)24U,
                  .end = r * (size_t)24U + (size_t)24U
...
- K= 3
*/
static KRML_MUSTINLINE Eurydice_arr_600 sample_from_xof_7e1(Eurydice_arr_81 *seeds)
{
...
- K= 3
*/
static KRML_MUSTINLINE Eurydice_arr_600 sample_from_xof_281(Eurydice_arr_81 *seeds)
{
  Eurydice_arr_eb0 sampled_coefficients = { .data = { 0U } };
  Eurydice_arr_b1
  out = { .data = { { .data = { 0U } }, { .data = { 0U } }, { .data = { 0U } } } };
...
*/
static KRML_MUSTINLINE void
sample_matrix_A_7e1(Eurydice_arr_601 *A_transpose, Eurydice_arr_31 *seed, bool transpose)
{
  KRML_MAYBE_FOR3(i0,
    (size_t)0U,
    (size_t)3U,
...
*/
static KRML_MUSTINLINE void
sample_matrix_A_281(Eurydice_arr_601 *A_transpose, Eurydice_arr_31 *seed, bool transpose)
{
  KRML_MAYBE_FOR3(i0,
    (size_t)0U,
    (size_t)3U,
...
- K= 3
*/
static Eurydice_arr_600 default_3c_e3(void)
{
  Eurydice_arr_600 lit;
  Eurydice_arr_13 repeat_expression[3U];
  KRML_MAYBE_FOR3(i, (size_t)0U, (size_t)3U, (size_t)1U, repeat_expression[i] = ZERO_0b_52(););
...
libcrux_ml_kem_ind_cca_generate_keypair_db1(Eurydice_arr_c7 *randomness)
{
  ...
  ind_cpa_keypair_randomness =
    Eurydice_array_to_subslice_mut_d49(randomness,
      (
        KRML_CLITERAL(core_ops_range_Range_87){
          .start = (size_t)0U,
          .end = LIBCRUX_ML_KEM_CONSTANTS_CPA_PKE_KEY_GENERATION_SEED_SIZE
  ...
  Eurydice_mut_borrow_slice_u8
  implicit_rejection_value =
    Eurydice_array_to_subslice_from_mut_5f1(randomness,
...
bool libcrux_ml_kem_ind_cca_validate_public_key_79(Eurydice_arr_5f *public_key)
{
  ...
  public_key_serialized =
    serialize_public_key_79(&deserialized_pk,
      Eurydice_array_to_subslice_from_mut_5f2(public_key,
        libcrux_ml_kem_constants_ranked_bytes_per_ring_element((size_t)3U)));
...
bool libcrux_ml_kem_ind_cca_validate_public_key_ce(Eurydice_arr_03 *public_key)
{
  ...
  public_key_serialized =
    serialize_public_key_ce(&deserialized_pk,
      Eurydice_array_to_subslice_from_mut_5f(public_key,
        libcrux_ml_kem_constants_ranked_bytes_per_ring_element((size_t)2U)));
...
)
{
  ...
  KRML_MAYBE_FOR3(i0,
    ...
    (size_t)1U,
    size_t i1 = i0;
    Eurydice_arr_600 *row = &a_as_ntt->data[i1];
    KRML_MAYBE_FOR3(i,
      (size_t)0U,
      (size_t)3U,
      (size_t)1U,
...
)
{
  ...
  uu____0 =
    encrypt_c1_781(randomness,
      &public_key->A,
      Eurydice_array_to_subslice_mut_d416(&ciphertext,
...
)
{
  ...
  uu____0 =
    encrypt_c1_78(randomness,
      &public_key->A,
      Eurydice_array_to_subslice_mut_d48(&ciphertext,
  ...
  encrypt_c2_e5(&public_key->t_as_ntt,
    ...
    &error_2,
    message,
    Eurydice_array_to_subslice_from_mut_5f0(&ciphertext, (size_t)640U));
  return ciphertext;
}
...
*/
static KRML_MUSTINLINE Eurydice_arr_ec
decrypt_unpacked_3e(Eurydice_arr_600 *secret_key, Eurydice_arr_2b *ciphertext)
{
  Eurydice_arr_600 u_as_ntt = deserialize_then_decompress_u_15(ciphertext);
  Eurydice_arr_13
  v =
    deserialize_then_decompress_ring_element_v_79(Eurydice_array_to_subslice_from_mut_5f3(ciphertext,
        (size_t)960U));
...
decrypt_unpacked_a4(Eurydice_arr_ee *secret_key, Eurydice_arr_d2 *ciphertext)
{
  ...
  Eurydice_arr_13
  v =
    deserialize_then_decompress_ring_element_v_ce(Eurydice_array_to_subslice_from_mut_5f0(ciphertext,
        (size_t)640U));
...
*/
static KRML_MUSTINLINE void
deserialize_vector_e3(Eurydice_mut_borrow_slice_u8 secret_key, Eurydice_arr_600 *secret_as_ntt)
{
  KRML_MAYBE_FOR3(i,
    (size_t)0U,
    (size_t)3U,
...
)
{
  ...
  Eurydice_mut_borrow_slice_u8
  uu____2 =
    Eurydice_array_to_subslice_from_mut_5f(&to_hash,
      LIBCRUX_ML_KEM_CONSTANTS_SHARED_SECRET_SIZE);
...
)
{
  ...
  unpacked_public_key->ind_cpa_public_key.seed_for_A =
    libcrux_ml_kem_utils_into_padded_array_ce(Eurydice_array_to_subslice_from_mut_5f2(public_key,
        (size_t)1152U));
  Eurydice_arr_601 *uu____2 = &unpacked_public_key->ind_cpa_public_key.A;
  /* original Rust expression is not an lvalue in C */
  Eurydice_arr_31
  lvalue =
    libcrux_ml_kem_utils_into_padded_array_de(Eurydice_array_to_subslice_from_mut_5f2(public_key,
        (size_t)1152U));
...
)
{
  ...
  deserialize_ring_elements_reduced_16(uu____0,
    &unpacked_public_key->ind_cpa_public_key.t_as_ntt);
  unpacked_public_key->ind_cpa_public_key.seed_for_A =
    libcrux_ml_kem_utils_into_padded_array_ce(Eurydice_array_to_subslice_from_mut_5f(public_key,
        (size_t)768U));
  Eurydice_arr_e2 *uu____2 = &unpacked_public_key->ind_cpa_public_key.A;
  /* original Rust expression is not an lvalue in C */
  Eurydice_arr_31
  lvalue =
    libcrux_ml_kem_utils_into_padded_array_de(Eurydice_array_to_subslice_from_mut_5f(public_key,
        (size_t)768U));
...
- K= 3
*/
static Eurydice_arr_601 transpose_a_e3(Eurydice_arr_601 ind_cpa_a)
{

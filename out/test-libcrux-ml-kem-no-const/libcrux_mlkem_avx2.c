...
This function found in impl {impl libcrux_ml_kem::vector::traits::Operations for libcrux_ml_kem::vector::avx2::SIMD256Vector}
*/
KRML_MUSTINLINE Eurydice_arr_d6 libcrux_ml_kem_vector_avx2_to_i16_array_14(__m256i x)
{
...
*/
KRML_MUSTINLINE __m256i
libcrux_ml_kem_vector_avx2_from_bytes_14(Eurydice_mut_borrow_slice_u8 array)
{
...
This function found in impl {impl libcrux_ml_kem::vector::traits::Operations for libcrux_ml_kem::vector::avx2::SIMD256Vector}
*/
KRML_MUSTINLINE Eurydice_arr_80 libcrux_ml_kem_vector_avx2_serialize_11_14(__m256i vector)
{
...
*/
static Eurydice_arr_13 ZERO_0b_52(void)
{
  Eurydice_arr_13 lit;
...
deserialize_to_reduced_ring_element_52(Eurydice_mut_borrow_slice_u8 serialized)
{
...
shake128_init_absorb_final_88_78(Eurydice_arr_81 *input)
{
  ...
  KRML_MAYBE_FOR3(i0,
    ...
    for (size_t i = (size_t)0U; i < (size_t)504U / (size_t)24U; i++)
    {
      ...
      if (sampled_coefficients->data[i1] < LIBCRUX_ML_KEM_CONSTANTS_COEFFICIENTS_IN_RING_ELEMENT)
      {
        size_t
        sampled =
          libcrux_ml_kem_vector_avx2_rej_sample_14(Eurydice_array_to_subslice_mut_d49(&randomness->data[i1],
              (
                KRML_CLITERAL(core_ops_range_Range_87){
                  .start = r * (size_t)24U,
  ...
  KRML_MAYBE_FOR3(i0,
    ...
    for (size_t i = (size_t)0U; i < (size_t)168U / (size_t)24U; i++)
    {
      ...
      if (sampled_coefficients->data[i1] < LIBCRUX_ML_KEM_CONSTANTS_COEFFICIENTS_IN_RING_ELEMENT)
      {
        size_t
        sampled =
          libcrux_ml_kem_vector_avx2_rej_sample_14(Eurydice_array_to_subslice_mut_d41(&randomness->data[i1],
              (
                KRML_CLITERAL(core_ops_range_Range_87){
                  .start = r * (size_t)24U,
                  .end = r * (size_t)24U + (size_t)24U
...
*/
static Eurydice_arr_13 ZERO_52(void)
{
  Eurydice_arr_13 lit;
  __m256i repeat_expression[16U];
  KRML_MAYBE_FOR16(i,
...
*/
static KRML_MUSTINLINE Eurydice_arr_13 from_i16_array_52(Eurydice_mut_borrow_slice_i16 a)
{
  ...
  for (size_t i = (size_t)0U; i < LIBCRUX_ML_KEM_POLYNOMIAL_VECTORS_IN_RING_ELEMENT; i++)
  {
    size_t i0 = i;
    result.data[i0] =
      libcrux_ml_kem_vector_avx2_from_i16_array_14(Eurydice_slice_subslice_mut_a6(a,
          (
            KRML_CLITERAL(core_ops_range_Range_87){
              .start = i0 * (size_t)16U,
...
*/
static KRML_MUSTINLINE Eurydice_arr_13 from_i16_array_0b_52(Eurydice_mut_borrow_slice_i16 a)
{
...
static Eurydice_arr_13 call_mut_f3_281(Eurydice_arr_5b tupled_args)
{
  ...
  return
    from_i16_array_0b_52(Eurydice_array_to_subslice_mut_e70(&s,
...
- K= 3
*/
static KRML_MUSTINLINE Eurydice_arr_ec H_88_78(Eurydice_mut_borrow_slice_u8 input)
{
...
)
{
  ...
  Eurydice_arr_ec
  uu____3 =
    H_88_78(Eurydice_array_to_slice_mut_ff(libcrux_ml_kem_types_as_slice_e6_3d(public_key)));
...
clone_80_e3(libcrux_ml_kem_ind_cpa_unpacked_IndCpaPublicKeyUnpacked_ef *self)
{
  Eurydice_arr_60
  uu____0 =
...
*/
static KRML_MUSTINLINE __m256i to_unsigned_field_modulus_52(__m256i a)
{
...
serialize_uncompressed_ring_element_52(Eurydice_arr_13 *re)
{
...
*/
static KRML_MUSTINLINE Eurydice_arr_5f
serialized_86_79(libcrux_ml_kem_ind_cca_unpacked_MlKemPublicKeyUnpacked_ef *self)
{
  return
...
*/
static KRML_MUSTINLINE Eurydice_arr_13
deserialize_to_uncompressed_ring_element_52(Eurydice_mut_borrow_slice_u8 serialized)
{
  Eurydice_arr_13 re = ZERO_0b_52();
  for (size_t i = (size_t)0U; i < serialized.meta / (size_t)24U; i++)
  {
...
deserialize_vector_e3(Eurydice_mut_borrow_slice_u8 secret_key, Eurydice_arr_60 *secret_as_ntt)
{
  KRML_MAYBE_FOR3(i,
    ...
    Eurydice_arr_13
    uu____0 =
      deserialize_to_uncompressed_ring_element_52(Eurydice_slice_subslice_mut_c8(secret_key,
          (
            KRML_CLITERAL(core_ops_range_Range_87){
              .start = i0 * LIBCRUX_ML_KEM_CONSTANTS_BYTES_PER_RING_ELEMENT,
              .end = (i0 + (size_t)1U) * LIBCRUX_ML_KEM_CONSTANTS_BYTES_PER_RING_ELEMENT
...
- K= 3
*/
static Eurydice_arr_60 default_3c_e3(void)
{
  Eurydice_arr_60 lit;
...
- K= 3
*/
static libcrux_ml_kem_ind_cpa_unpacked_IndCpaPublicKeyUnpacked_ef default_c4_e3(void)
{
...
- K= 3
*/
static KRML_MUSTINLINE Eurydice_arr_c7 G_88_78(Eurydice_mut_borrow_slice_u8 input)
{
...
cpa_keygen_seed_1e_b6(Eurydice_mut_borrow_slice_u8 key_generation_seed)
{
  ...
  return G_88_78(Eurydice_array_to_slice_mut_b5(&seed));
}
...
- LEN= 128
*/
static KRML_MUSTINLINE Eurydice_arr_58 PRFxN_88_3b(Eurydice_arr_801 *input)
{
...
*/
static KRML_MUSTINLINE Eurydice_arr_13
sample_from_binomial_distribution_3_52(Eurydice_mut_borrow_slice_u8 randomness)
{
  ...
  return from_i16_array_0b_52(Eurydice_array_to_slice_mut_990(&sampled_i16s));
}
...
*/
static KRML_MUSTINLINE Eurydice_arr_13
sample_from_binomial_distribution_2_52(Eurydice_mut_borrow_slice_u8 randomness)
{
  Eurydice_arr_04 sampled_i16s = { .data = { 0U } };
...
*/
static KRML_MUSTINLINE void ntt_at_layer_7_52(Eurydice_arr_13 *re)
{
...
*/
static KRML_MUSTINLINE void ntt_at_layer_3_52(size_t *zeta_i, Eurydice_arr_13 *re)
{
  KRML_MAYBE_FOR16(i,
    (size_t)0U,
    (size_t)16U,
...
*/
static KRML_MUSTINLINE void ntt_at_layer_2_52(size_t *zeta_i, Eurydice_arr_13 *re)
{
  KRML_MAYBE_FOR16(i,
    (size_t)0U,
    (size_t)16U,
...
*/
static KRML_MUSTINLINE void ntt_at_layer_1_52(size_t *zeta_i, Eurydice_arr_13 *re)
{
  KRML_MAYBE_FOR16(i,
    (size_t)0U,
    (size_t)16U,
...
*/
static KRML_MUSTINLINE void poly_barrett_reduce_52(Eurydice_arr_13 *myself)
{
  for (size_t i = (size_t)0U; i < LIBCRUX_ML_KEM_POLYNOMIAL_VECTORS_IN_RING_ELEMENT; i++)
  {
    size_t i0 = i;
...
*/
static KRML_MUSTINLINE void poly_barrett_reduce_0b_52(Eurydice_arr_13 *self)
{
...
*/
static KRML_MUSTINLINE void ntt_binomially_sampled_ring_element_52(Eurydice_arr_13 *re)
{
...
*/
static KRML_MUSTINLINE Eurydice_arr_13
ntt_multiply_52(Eurydice_arr_13 *myself, Eurydice_arr_13 *rhs)
{
...
*/
static KRML_MUSTINLINE Eurydice_arr_13
ntt_multiply_0b_52(Eurydice_arr_13 *self, Eurydice_arr_13 *rhs)
{
...
*/
static KRML_MUSTINLINE void
add_to_ring_element_0b_e3(Eurydice_arr_13 *self, Eurydice_arr_13 *rhs)
{
...
*/
static KRML_MUSTINLINE __m256i to_standard_domain_52(__m256i vector)
{
  return
...
*/
static KRML_MUSTINLINE void
add_standard_error_reduce_52(Eurydice_arr_13 *myself, Eurydice_arr_13 *error)
{
  for (size_t i = (size_t)0U; i < LIBCRUX_ML_KEM_POLYNOMIAL_VECTORS_IN_RING_ELEMENT; i++)
  {
    size_t j = i;
...
*/
static KRML_MUSTINLINE void
add_standard_error_reduce_0b_52(Eurydice_arr_13 *self, Eurydice_arr_13 *error)
{
...
- K= 3
*/
static Eurydice_arr_60 call_mut_ae_e3(void **_)
{
  Eurydice_arr_60 arr_struct;
  KRML_MAYBE_FOR3(i,
    (size_t)0U,
...
*/
static inline Eurydice_arr_13 clone_d1_52(Eurydice_arr_13 *self)
{
  return
...
)
{
  ...
  Eurydice_arr_ec uu____0 = H_88_78(Eurydice_array_to_slice_mut_ff(&pk_serialized));
...
)
{
  ...
  Eurydice_slice_copy(Eurydice_array_to_subslice_from_mut_5f0(&to_hash,
    ...
    pk_hash,
    uint8_t);
  return G_88_78(Eurydice_array_to_slice_mut_17(&to_hash));
}
...
- LEN= 128
*/
static KRML_MUSTINLINE Eurydice_arr_89 PRF_88_3b0(Eurydice_mut_borrow_slice_u8 input)
{
  return PRF_ec(input);
}
...
*/
static KRML_MUSTINLINE void invert_ntt_at_layer_1_52(size_t *zeta_i, Eurydice_arr_13 *re)
{
  KRML_MAYBE_FOR16(i,
    (size_t)0U,
    (size_t)16U,
...
*/
static KRML_MUSTINLINE void invert_ntt_at_layer_2_52(size_t *zeta_i, Eurydice_arr_13 *re)
{
  KRML_MAYBE_FOR16(i,
    (size_t)0U,
    (size_t)16U,
...
*/
static KRML_MUSTINLINE void invert_ntt_at_layer_3_52(size_t *zeta_i, Eurydice_arr_13 *re)
{
  KRML_MAYBE_FOR16(i,
    (size_t)0U,
    (size_t)16U,
...
*/
static KRML_MUSTINLINE void
add_error_reduce_52(Eurydice_arr_13 *myself, Eurydice_arr_13 *error)
{
  for (size_t i = (size_t)0U; i < LIBCRUX_ML_KEM_POLYNOMIAL_VECTORS_IN_RING_ELEMENT; i++)
  {
    size_t j = i;
...
*/
static KRML_MUSTINLINE void
add_error_reduce_0b_52(Eurydice_arr_13 *self, Eurydice_arr_13 *error)
{
...
- COEFFICIENT_BITS= 10
*/
static KRML_MUSTINLINE __m256i compress_14_ef(__m256i vector)
{
...
)
{
  ...
  Eurydice_arr_89 prf_output = PRF_88_3b0(Eurydice_array_to_slice_mut_b5(&prf_input));
  Eurydice_arr_13
...
*/
static KRML_MUSTINLINE Eurydice_arr_13
deserialize_then_decompress_message_52(Eurydice_arr_ec *serialized)
{
  Eurydice_arr_13 re = ZERO_0b_52();
  KRML_MAYBE_FOR16(i,
    (size_t)0U,
    ...
    coefficient_compressed =
      libcrux_ml_kem_vector_avx2_deserialize_1_14(Eurydice_array_to_subslice_mut_d44(serialized,
          (
            KRML_CLITERAL(core_ops_range_Range_87){
              .start = (size_t)2U * i0,
...
- COEFFICIENT_BITS= 5
*/
static KRML_MUSTINLINE __m256i compress_14_f4(__m256i vector)
{
...
- COEFFICIENT_BITS= 11
*/
static KRML_MUSTINLINE __m256i decompress_ciphertext_coefficient_14_c4(__m256i vector)
{
...
*/
static KRML_MUSTINLINE Eurydice_arr_13
deserialize_then_decompress_11_52(Eurydice_mut_borrow_slice_u8 serialized)
{
  Eurydice_arr_13 re = ZERO_0b_52();
...
*/
static KRML_MUSTINLINE Eurydice_arr_13
deserialize_then_decompress_10_52(Eurydice_mut_borrow_slice_u8 serialized)
{
  Eurydice_arr_13 re = ZERO_0b_52();
...
- COEFFICIENT_BITS= 5
*/
static KRML_MUSTINLINE __m256i decompress_ciphertext_coefficient_14_f4(__m256i vector)
{
...
*/
static KRML_MUSTINLINE Eurydice_arr_13
deserialize_then_decompress_5_52(Eurydice_mut_borrow_slice_u8 serialized)
{
  Eurydice_arr_13 re = ZERO_0b_52();
...
*/
static KRML_MUSTINLINE Eurydice_arr_13
deserialize_then_decompress_4_52(Eurydice_mut_borrow_slice_u8 serialized)
{
  Eurydice_arr_13 re = ZERO_0b_52();
...
*/
static KRML_MUSTINLINE Eurydice_arr_13
subtract_reduce_52(Eurydice_arr_13 *myself, Eurydice_arr_13 b)
{
  for (size_t i = (size_t)0U; i < LIBCRUX_ML_KEM_POLYNOMIAL_VECTORS_IN_RING_ELEMENT; i++)
  {
    size_t i0 = i;
...
*/
static KRML_MUSTINLINE Eurydice_arr_13
subtract_reduce_0b_52(Eurydice_arr_13 *self, Eurydice_arr_13 b)
{
...
*/
static KRML_MUSTINLINE Eurydice_arr_ec compress_then_serialize_message_52(Eurydice_arr_13 re)
{
  Eurydice_arr_ec serialized = { .data = { 0U } };
  KRML_MAYBE_FOR16(i,
    (size_t)0U,
...
- LEN= 32
*/
static KRML_MUSTINLINE Eurydice_arr_ec PRF_88_3b(Eurydice_mut_borrow_slice_u8 input)
{
  return PRF_ce(input);
}
...
)
{
  ...
  Eurydice_slice_copy(uu____0,
    ...
    uint8_t);
  Eurydice_arr_c7 hashed = G_88_78(Eurydice_array_to_slice_mut_17(&to_hash0));
  Eurydice_mut_borrow_slice_u8_x2
  uu____1 =
    Eurydice_slice_split_at(Eurydice_array_to_slice_mut_17(&hashed),
      LIBCRUX_ML_KEM_CONSTANTS_SHARED_SECRET_SIZE,
  ...
  Eurydice_arr_ec
  implicit_rejection_shared_secret = PRF_88_3b(Eurydice_array_to_slice_mut_81(&to_hash));
  Eurydice_arr_2b
  expected_ciphertext =
    encrypt_unpacked_281(&key_pair->public_key.ind_cpa_public_key,
      &decrypted,
      pseudorandomness);
  Eurydice_mut_borrow_slice_u8 uu____3 = libcrux_ml_kem_types_as_ref_17_52(ciphertext);
  uint8_t
  selector =
...
bool libcrux_ml_kem_ind_cca_validate_private_key_only_a4(Eurydice_arr_7d *private_key)
{
  Eurydice_arr_ec
  t =
    H_88_78(Eurydice_array_to_subslice_mut_d418(private_key,
        (
          KRML_CLITERAL(core_ops_range_Range_87){
...
{
  Eurydice_arr_60 private_key = default_3c_e3();
...
- CIPHERTEXT_SIZE= 1088
*/
static KRML_MUSTINLINE Eurydice_arr_ec kdf_1e_a4(Eurydice_mut_borrow_slice_u8 shared_secret)
{
  Eurydice_arr_ec out = { .data = { 0U } };
...
)
{
  ...
  lvalue =
    H_88_78(Eurydice_array_to_slice_mut_ff(libcrux_ml_kem_types_as_slice_e6_3d(public_key)));
  Eurydice_slice_copy(uu____0, Eurydice_array_to_slice_mut_01(&lvalue), uint8_t);
  Eurydice_arr_c7 hashed = G_88_78(Eurydice_array_to_slice_mut_17(&to_hash));
  Eurydice_mut_borrow_slice_u8_x2
  uu____1 =
    Eurydice_slice_split_at(Eurydice_array_to_slice_mut_17(&hashed),
      LIBCRUX_ML_KEM_CONSTANTS_SHARED_SECRET_SIZE,
...
)
{
  ...
  Eurydice_mut_borrow_slice_u8 uu____4 = libcrux_ml_kem_types_as_ref_17_52(ciphertext);
  return
...
*/
static KRML_MUSTINLINE Eurydice_arr_c40
shake128_init_absorb_final_88_23(Eurydice_arr_56 *input)
{
...
- K= 4
*/
static KRML_MUSTINLINE Eurydice_arr_ec H_88_23(Eurydice_mut_borrow_slice_u8 input)
{
  return libcrux_ml_kem_hash_functions_avx2_H(input);
}
...
)
{
  ...
  Eurydice_arr_ec
  uu____3 =
    H_88_23(Eurydice_array_to_slice_mut_b50(libcrux_ml_kem_types_as_slice_e6_d9(public_key)));
  unpacked_public_key->public_key_hash = uu____3;
}
...
*/
static KRML_MUSTINLINE Eurydice_arr_d1
serialized_86_74(libcrux_ml_kem_ind_cca_unpacked_MlKemPublicKeyUnpacked_d4 *self)
{
  return
...
- K= 4
*/
static Eurydice_arr_3b default_3c_5b(void)
{
  Eurydice_arr_3b lit;
...
- K= 4
*/
static libcrux_ml_kem_ind_cpa_unpacked_IndCpaPublicKeyUnpacked_d4 default_c4_5b(void)
{
...
- K= 4
*/
static KRML_MUSTINLINE Eurydice_arr_c7 G_88_23(Eurydice_mut_borrow_slice_u8 input)
{
  return libcrux_ml_kem_hash_functions_avx2_G(input);
}
...
cpa_keygen_seed_1e_39(Eurydice_mut_borrow_slice_u8 key_generation_seed)
{
  ...
  return G_88_23(Eurydice_array_to_slice_mut_b5(&seed));
}
...
- LEN= 128
*/
static KRML_MUSTINLINE Eurydice_arr_3b0 PRFxN_88_f5(Eurydice_arr_890 *input)
{
...
*/
static KRML_MUSTINLINE void
add_to_ring_element_0b_5b(Eurydice_arr_13 *self, Eurydice_arr_13 *rhs)
{
...
)
{
  ...
  pk_serialized =
    serialize_public_key_74(&out->public_key.ind_cpa_public_key.t_as_ntt,
      Eurydice_array_to_slice_mut_01(&out->public_key.ind_cpa_public_key.seed_for_A));
  Eurydice_arr_ec uu____0 = H_88_23(Eurydice_array_to_slice_mut_b50(&pk_serialized));
  out->public_key.public_key_hash = uu____0;
  Eurydice_arr_ec arr;
  memcpy(arr.data, implicit_rejection_value.ptr, (size_t)32U * sizeof (uint8_t));
  Eurydice_arr_ec
...
)
{
  ...
  Eurydice_slice_copy(Eurydice_array_to_subslice_from_mut_5f0(&to_hash,
    ...
    pk_hash,
    uint8_t);
  return G_88_23(Eurydice_array_to_slice_mut_17(&to_hash));
}
...
- LEN= 128
*/
static KRML_MUSTINLINE Eurydice_arr_89 PRF_88_f50(Eurydice_mut_borrow_slice_u8 input)
{
  return PRF_ec(input);
}
...
)
{
  ...
  prf_input.data[32U] = domain_separator;
  Eurydice_arr_89 prf_output = PRF_88_f50(Eurydice_array_to_slice_mut_b5(&prf_input));
  Eurydice_arr_13
  error_2 = sample_from_binomial_distribution_16(Eurydice_array_to_slice_mut_78(&prf_output));
...
- LEN= 32
*/
static KRML_MUSTINLINE Eurydice_arr_ec PRF_88_f5(Eurydice_mut_borrow_slice_u8 input)
{
  return PRF_ce(input);
}
...
)
{
  ...
  Eurydice_slice_copy(uu____0,
    Eurydice_array_to_slice_mut_01(&key_pair->public_key.public_key_hash),
    uint8_t);
  Eurydice_arr_c7 hashed = G_88_23(Eurydice_array_to_slice_mut_17(&to_hash0));
  Eurydice_mut_borrow_slice_u8_x2
  uu____1 =
    Eurydice_slice_split_at(Eurydice_array_to_slice_mut_17(&hashed),
      LIBCRUX_ML_KEM_CONSTANTS_SHARED_SECRET_SIZE,
  ...
  Eurydice_arr_ec
  implicit_rejection_shared_secret = PRF_88_f5(Eurydice_array_to_slice_mut_720(&to_hash));
  Eurydice_arr_d1
  expected_ciphertext =
    encrypt_unpacked_280(&key_pair->public_key.ind_cpa_public_key,
      &decrypted,
      pseudorandomness);
  Eurydice_mut_borrow_slice_u8 uu____3 = libcrux_ml_kem_types_as_ref_17_d9(ciphertext);
  uint8_t
  selector =
    libcrux_ml_kem_constant_time_ops_compare_ciphertexts_in_constant_time(uu____3,
...
bool libcrux_ml_kem_ind_cca_validate_private_key_only_f8(Eurydice_arr_a8 *private_key)
{
  Eurydice_arr_ec
  t =
    H_88_23(Eurydice_array_to_subslice_mut_d422(private_key,
        (
          KRML_CLITERAL(core_ops_range_Range_87){
...
- CIPHERTEXT_SIZE= 1568
*/
static KRML_MUSTINLINE Eurydice_arr_ec kdf_1e_f8(Eurydice_mut_borrow_slice_u8 shared_secret)
{
  Eurydice_arr_ec out = { .data = { 0U } };
  Eurydice_slice_copy(Eurydice_array_to_slice_mut_01(&out), shared_secret, uint8_t);
  return out;
...
)
{
  ...
  lvalue =
    H_88_23(Eurydice_array_to_slice_mut_b50(libcrux_ml_kem_types_as_slice_e6_d9(public_key)));
  Eurydice_slice_copy(uu____0, Eurydice_array_to_slice_mut_01(&lvalue), uint8_t);
  Eurydice_arr_c7 hashed = G_88_23(Eurydice_array_to_slice_mut_17(&to_hash));
  Eurydice_mut_borrow_slice_u8_x2
  uu____1 =
    Eurydice_slice_split_at(Eurydice_array_to_slice_mut_17(&hashed),
      LIBCRUX_ML_KEM_CONSTANTS_SHARED_SECRET_SIZE,
...
)
{
  ...
  Eurydice_mut_borrow_slice_u8 uu____4 = libcrux_ml_kem_types_as_ref_17_d9(ciphertext);
  return
    libcrux_ml_kem_constant_time_ops_compare_ciphertexts_select_shared_secret_in_constant_time(uu____4,
      Eurydice_array_to_slice_mut_b50(&expected_ciphertext),
      Eurydice_array_to_slice_mut_01(&shared_secret),
...
*/
static KRML_MUSTINLINE Eurydice_arr_c40
shake128_init_absorb_final_88_af(Eurydice_arr_bf *input)
{
...
- K= 2
*/
static KRML_MUSTINLINE Eurydice_arr_ec H_88_af(Eurydice_mut_borrow_slice_u8 input)
{
  return libcrux_ml_kem_hash_functions_avx2_H(input);
}
...
)
{
  ...
  Eurydice_arr_ec
  uu____3 =
    H_88_af(Eurydice_array_to_slice_mut_3b(libcrux_ml_kem_types_as_slice_e6_df(public_key)));
  unpacked_public_key->public_key_hash = uu____3;
}
...
*/
static KRML_MUSTINLINE Eurydice_arr_03
serialized_86_ce(libcrux_ml_kem_ind_cca_unpacked_MlKemPublicKeyUnpacked_c7 *self)
{
  return
...
- K= 2
*/
static Eurydice_arr_ee default_3c_16(void)
{
  Eurydice_arr_ee lit;
...
- K= 2
*/
static libcrux_ml_kem_ind_cpa_unpacked_IndCpaPublicKeyUnpacked_c7 default_c4_16(void)
{
...
- K= 2
*/
static KRML_MUSTINLINE Eurydice_arr_c7 G_88_af(Eurydice_mut_borrow_slice_u8 input)
{
  return libcrux_ml_kem_hash_functions_avx2_G(input);
}
...
cpa_keygen_seed_1e_b1(Eurydice_mut_borrow_slice_u8 key_generation_seed)
{
  ...
  return G_88_af(Eurydice_array_to_slice_mut_b5(&seed));
}
...
- LEN= 192
*/
static KRML_MUSTINLINE Eurydice_arr_eb PRFxN_88_d5(Eurydice_arr_4d *input)
{
...
*/
static KRML_MUSTINLINE void
add_to_ring_element_0b_16(Eurydice_arr_13 *self, Eurydice_arr_13 *rhs)
{
...
)
{
  ...
  pk_serialized =
    serialize_public_key_ce(&out->public_key.ind_cpa_public_key.t_as_ntt,
      Eurydice_array_to_slice_mut_01(&out->public_key.ind_cpa_public_key.seed_for_A));
  Eurydice_arr_ec uu____0 = H_88_af(Eurydice_array_to_slice_mut_3b(&pk_serialized));
  out->public_key.public_key_hash = uu____0;
  Eurydice_arr_ec arr;
  memcpy(arr.data, implicit_rejection_value.ptr, (size_t)32U * sizeof (uint8_t));
  Eurydice_arr_ec
...
)
{
  ...
  Eurydice_slice_copy(Eurydice_array_to_subslice_from_mut_5f0(&to_hash,
    ...
    pk_hash,
    uint8_t);
  return G_88_af(Eurydice_array_to_slice_mut_17(&to_hash));
}
...
- LEN= 128
*/
static KRML_MUSTINLINE Eurydice_arr_f3 PRFxN_88_d50(Eurydice_arr_4d *input)
{
...
- LEN= 128
*/
static KRML_MUSTINLINE Eurydice_arr_89 PRF_88_d50(Eurydice_mut_borrow_slice_u8 input)
{
  return PRF_ec(input);
}
...
)
{
  ...
  prf_input.data[32U] = domain_separator;
  Eurydice_arr_89 prf_output = PRF_88_d50(Eurydice_array_to_slice_mut_b5(&prf_input));
  Eurydice_arr_13
  error_2 = sample_from_binomial_distribution_16(Eurydice_array_to_slice_mut_78(&prf_output));
...
- LEN= 32
*/
static KRML_MUSTINLINE Eurydice_arr_ec PRF_88_d5(Eurydice_mut_borrow_slice_u8 input)
{
  return PRF_ce(input);
}
...
)
{
  ...
  Eurydice_slice_copy(uu____0,
    Eurydice_array_to_slice_mut_01(&key_pair->public_key.public_key_hash),
    uint8_t);
  Eurydice_arr_c7 hashed = G_88_af(Eurydice_array_to_slice_mut_17(&to_hash0));
  Eurydice_mut_borrow_slice_u8_x2
  uu____1 =
    Eurydice_slice_split_at(Eurydice_array_to_slice_mut_17(&hashed),
      LIBCRUX_ML_KEM_CONSTANTS_SHARED_SECRET_SIZE,
  ...
  Eurydice_arr_ec
  implicit_rejection_shared_secret = PRF_88_d5(Eurydice_array_to_slice_mut_3b(&to_hash));
  Eurydice_arr_d2
  expected_ciphertext =
    encrypt_unpacked_28(&key_pair->public_key.ind_cpa_public_key,
      &decrypted,
      pseudorandomness);
  Eurydice_mut_borrow_slice_u8 uu____3 = libcrux_ml_kem_types_as_ref_17_80(ciphertext);
  uint8_t
  selector =
    libcrux_ml_kem_constant_time_ops_compare_ciphertexts_in_constant_time(uu____3,
...
bool libcrux_ml_kem_ind_cca_validate_private_key_only_37(Eurydice_arr_ab0 *private_key)
{
  Eurydice_arr_ec
  t =
    H_88_af(Eurydice_array_to_subslice_mut_d414(private_key,
        (
          KRML_CLITERAL(core_ops_range_Range_87){
...
- CIPHERTEXT_SIZE= 768
*/
static KRML_MUSTINLINE Eurydice_arr_ec kdf_1e_37(Eurydice_mut_borrow_slice_u8 shared_secret)
{
  Eurydice_arr_ec out = { .data = { 0U } };
  Eurydice_slice_copy(Eurydice_array_to_slice_mut_01(&out), shared_secret, uint8_t);
  return out;
...
libcrux_ml_kem_ind_cca_encapsulate_a1(Eurydice_arr_03 *public_key, Eurydice_arr_ec *randomness)
{
  ...
  lvalue =
    H_88_af(Eurydice_array_to_slice_mut_3b(libcrux_ml_kem_types_as_slice_e6_df(public_key)));
  Eurydice_slice_copy(uu____0, Eurydice_array_to_slice_mut_01(&lvalue), uint8_t);
  Eurydice_arr_c7 hashed = G_88_af(Eurydice_array_to_slice_mut_17(&to_hash));
  Eurydice_mut_borrow_slice_u8_x2
  uu____1 =
    Eurydice_slice_split_at(Eurydice_array_to_slice_mut_17(&hashed),
      LIBCRUX_ML_KEM_CONSTANTS_SHARED_SECRET_SIZE,
...
)
{
  ...
  Eurydice_mut_borrow_slice_u8 uu____4 = libcrux_ml_kem_types_as_ref_17_80(ciphertext);
  return
    libcrux_ml_kem_constant_time_ops_compare_ciphertexts_select_shared_secret_in_constant_time(uu____4,
      Eurydice_array_to_slice_mut_27(&expected_ciphertext),
      Eurydice_array_to_slice_mut_01(&shared_secret),

/* 
  ...
  KaRaMeL invocation: ./eurydice --output out/test-dst test/dst.llbc --log *
  F* version: <unknown>
...
void dst_check_var_field_ref3(Eurydice_dst_f1 x)
{
  ...
  uu____2.fst =
    &Eurydice_slice_index(Eurydice_slice_of_dst(&Eurydice_dst_deref(x, dst_T3, dst_T3).my_data,
        x.len,
        uint32_t [3U],
        Eurydice_slice),
      uu____0,

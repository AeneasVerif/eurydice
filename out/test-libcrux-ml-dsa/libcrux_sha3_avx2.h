...
- RIGHT= 63
*/
static KRML_MUSTINLINE __m256i libcrux_sha3_simd_avx2_rotate_left_76(__m256i x)
{
  return
...
static KRML_MUSTINLINE __m256i libcrux_sha3_simd_avx2__vrax1q_u64(__m256i a, __m256i b)
{
  return mm256_xor_si256(a, libcrux_sha3_simd_avx2_rotate_left_76(b));
}
...
static KRML_MUSTINLINE __m256i libcrux_sha3_simd_avx2__veorq_n_u64(__m256i a, uint64_t c)
{
...
This function found in impl {libcrux_sha3::traits::KeccakItem<4usize> for core::core_arch::x86::__m256i}
*/
static KRML_MUSTINLINE __m256i libcrux_sha3_simd_avx2_xor_constant_b0(__m256i a, uint64_t c)
{
...
This function found in impl {libcrux_sha3::traits::KeccakItem<4usize> for core::core_arch::x86::__m256i}
*/
static KRML_MUSTINLINE __m256i libcrux_sha3_simd_avx2_xor_b0(__m256i a, __m256i b)
{
...
- N= 4
*/
static KRML_MUSTINLINE Eurydice_arr_05 libcrux_sha3_generic_keccak_new_80_a6(void)
{
  Eurydice_arr_05 lit;
...
*/
static KRML_MUSTINLINE Eurydice_arr_05 libcrux_sha3_avx2_x4_incremental_init(void)
{
...
)
{
  for (size_t i = (size_t)0U; i < (size_t)168U / (size_t)32U; i++)
  {
    ...
    libcrux_sha3_traits_set_ij_a6(state,
      i0,
      j0,
      mm256_xor_si256(libcrux_sha3_traits_get_ij_a6(state, i0, j0)[0U], v0));
    libcrux_sha3_traits_set_ij_a6(state,
      i1,
      j1,
      mm256_xor_si256(libcrux_sha3_traits_get_ij_a6(state, i1, j1)[0U], v1));
    libcrux_sha3_traits_set_ij_a6(state,
      i2,
      j2,
      mm256_xor_si256(libcrux_sha3_traits_get_ij_a6(state, i2, j2)[0U], v2));
    libcrux_sha3_traits_set_ij_a6(state,
      i3,
      j3,
      mm256_xor_si256(libcrux_sha3_traits_get_ij_a6(state, i3, j3)[0U], v3));
  }
  ...
  libcrux_sha3_traits_set_ij_a6(state,
    i0,
    j0,
    mm256_xor_si256(libcrux_sha3_traits_get_ij_a6(state, i0, j0)[0U], u));
  if (rem == (size_t)16U)
  {
    ...
    libcrux_sha3_traits_set_ij_a6(state,
      i,
      j,
      mm256_xor_si256(libcrux_sha3_traits_get_ij_a6(state, i, j)[0U], u0));
  }
}
...
- RIGHT= 28
*/
static KRML_MUSTINLINE __m256i libcrux_sha3_simd_avx2_rotate_left_02(__m256i x)
{
  return
...
- RIGHT= 28
*/
static KRML_MUSTINLINE __m256i libcrux_sha3_simd_avx2__vxarq_u64_02(__m256i a, __m256i b)
{
  __m256i ab = mm256_xor_si256(a, b);
...
- RIGHT= 61
*/
static KRML_MUSTINLINE __m256i libcrux_sha3_simd_avx2_rotate_left_ac(__m256i x)
{
  return
...
- RIGHT= 61
*/
static KRML_MUSTINLINE __m256i libcrux_sha3_simd_avx2__vxarq_u64_ac(__m256i a, __m256i b)
{
  __m256i ab = mm256_xor_si256(a, b);
...
- RIGHT= 23
*/
static KRML_MUSTINLINE __m256i libcrux_sha3_simd_avx2_rotate_left_020(__m256i x)
{
  return
...
- RIGHT= 23
*/
static KRML_MUSTINLINE __m256i libcrux_sha3_simd_avx2__vxarq_u64_020(__m256i a, __m256i b)
{
  __m256i ab = mm256_xor_si256(a, b);
...
- RIGHT= 46
*/
static KRML_MUSTINLINE __m256i libcrux_sha3_simd_avx2_rotate_left_a9(__m256i x)
{
  return
...
- RIGHT= 46
*/
static KRML_MUSTINLINE __m256i libcrux_sha3_simd_avx2__vxarq_u64_a9(__m256i a, __m256i b)
{
  __m256i ab = mm256_xor_si256(a, b);
...
- RIGHT= 63
*/
static KRML_MUSTINLINE __m256i libcrux_sha3_simd_avx2__vxarq_u64_76(__m256i a, __m256i b)
{
  __m256i ab = mm256_xor_si256(a, b);
...
- RIGHT= 20
*/
static KRML_MUSTINLINE __m256i libcrux_sha3_simd_avx2_rotate_left_58(__m256i x)
{
  return
...
- RIGHT= 20
*/
static KRML_MUSTINLINE __m256i libcrux_sha3_simd_avx2__vxarq_u64_58(__m256i a, __m256i b)
{
  __m256i ab = mm256_xor_si256(a, b);
...
- RIGHT= 54
*/
static KRML_MUSTINLINE __m256i libcrux_sha3_simd_avx2_rotate_left_e0(__m256i x)
{
  return
...
- RIGHT= 54
*/
static KRML_MUSTINLINE __m256i libcrux_sha3_simd_avx2__vxarq_u64_e0(__m256i a, __m256i b)
{
  __m256i ab = mm256_xor_si256(a, b);
...
- RIGHT= 19
*/
static KRML_MUSTINLINE __m256i libcrux_sha3_simd_avx2_rotate_left_63(__m256i x)
{
  return
...
- RIGHT= 19
*/
static KRML_MUSTINLINE __m256i libcrux_sha3_simd_avx2__vxarq_u64_63(__m256i a, __m256i b)
{
  __m256i ab = mm256_xor_si256(a, b);
...
- RIGHT= 62
*/
static KRML_MUSTINLINE __m256i libcrux_sha3_simd_avx2_rotate_left_6a(__m256i x)
{
  return
...
- RIGHT= 62
*/
static KRML_MUSTINLINE __m256i libcrux_sha3_simd_avx2__vxarq_u64_6a(__m256i a, __m256i b)
{
  __m256i ab = mm256_xor_si256(a, b);
...
- RIGHT= 2
*/
static KRML_MUSTINLINE __m256i libcrux_sha3_simd_avx2_rotate_left_ab(__m256i x)
{
  return
...
- RIGHT= 2
*/
static KRML_MUSTINLINE __m256i libcrux_sha3_simd_avx2__vxarq_u64_ab(__m256i a, __m256i b)
{
  __m256i ab = mm256_xor_si256(a, b);
...
- RIGHT= 58
*/
static KRML_MUSTINLINE __m256i libcrux_sha3_simd_avx2_rotate_left_5b(__m256i x)
{
  return
...
- RIGHT= 58
*/
static KRML_MUSTINLINE __m256i libcrux_sha3_simd_avx2__vxarq_u64_5b(__m256i a, __m256i b)
{
  __m256i ab = mm256_xor_si256(a, b);
...
- RIGHT= 21
*/
static KRML_MUSTINLINE __m256i libcrux_sha3_simd_avx2_rotate_left_6f(__m256i x)
{
  return
...
- RIGHT= 21
*/
static KRML_MUSTINLINE __m256i libcrux_sha3_simd_avx2__vxarq_u64_6f(__m256i a, __m256i b)
{
  __m256i ab = mm256_xor_si256(a, b);
...
- RIGHT= 49
*/
static KRML_MUSTINLINE __m256i libcrux_sha3_simd_avx2_rotate_left_62(__m256i x)
{
  return
...
- RIGHT= 49
*/
static KRML_MUSTINLINE __m256i libcrux_sha3_simd_avx2__vxarq_u64_62(__m256i a, __m256i b)
{
  __m256i ab = mm256_xor_si256(a, b);
...
- RIGHT= 3
*/
static KRML_MUSTINLINE __m256i libcrux_sha3_simd_avx2_rotate_left_23(__m256i x)
{
  return
...
- RIGHT= 3
*/
static KRML_MUSTINLINE __m256i libcrux_sha3_simd_avx2__vxarq_u64_23(__m256i a, __m256i b)
{
  __m256i ab = mm256_xor_si256(a, b);
...
- RIGHT= 36
*/
static KRML_MUSTINLINE __m256i libcrux_sha3_simd_avx2_rotate_left_37(__m256i x)
{
  return
...
- RIGHT= 36
*/
static KRML_MUSTINLINE __m256i libcrux_sha3_simd_avx2__vxarq_u64_37(__m256i a, __m256i b)
{
  __m256i ab = mm256_xor_si256(a, b);
...
- RIGHT= 9
*/
static KRML_MUSTINLINE __m256i libcrux_sha3_simd_avx2_rotate_left_bb(__m256i x)
{
  return
...
- RIGHT= 9
*/
static KRML_MUSTINLINE __m256i libcrux_sha3_simd_avx2__vxarq_u64_bb(__m256i a, __m256i b)
{
  __m256i ab = mm256_xor_si256(a, b);
...
- RIGHT= 39
*/
static KRML_MUSTINLINE __m256i libcrux_sha3_simd_avx2_rotate_left_b9(__m256i x)
{
  return
...
- RIGHT= 39
*/
static KRML_MUSTINLINE __m256i libcrux_sha3_simd_avx2__vxarq_u64_b9(__m256i a, __m256i b)
{
  __m256i ab = mm256_xor_si256(a, b);
...
- RIGHT= 43
*/
static KRML_MUSTINLINE __m256i libcrux_sha3_simd_avx2_rotate_left_54(__m256i x)
{
  return
...
- RIGHT= 43
*/
static KRML_MUSTINLINE __m256i libcrux_sha3_simd_avx2__vxarq_u64_54(__m256i a, __m256i b)
{
  __m256i ab = mm256_xor_si256(a, b);
...
- RIGHT= 8
*/
static KRML_MUSTINLINE __m256i libcrux_sha3_simd_avx2_rotate_left_4c(__m256i x)
{
  return
...
- RIGHT= 8
*/
static KRML_MUSTINLINE __m256i libcrux_sha3_simd_avx2__vxarq_u64_4c(__m256i a, __m256i b)
{
  __m256i ab = mm256_xor_si256(a, b);
...
- RIGHT= 37
*/
static KRML_MUSTINLINE __m256i libcrux_sha3_simd_avx2_rotate_left_ce(__m256i x)
{
  return
...
- RIGHT= 37
*/
static KRML_MUSTINLINE __m256i libcrux_sha3_simd_avx2__vxarq_u64_ce(__m256i a, __m256i b)
{
  __m256i ab = mm256_xor_si256(a, b);
...
- RIGHT= 44
*/
static KRML_MUSTINLINE __m256i libcrux_sha3_simd_avx2_rotate_left_77(__m256i x)
{
  return
...
- RIGHT= 44
*/
static KRML_MUSTINLINE __m256i libcrux_sha3_simd_avx2__vxarq_u64_77(__m256i a, __m256i b)
{
  __m256i ab = mm256_xor_si256(a, b);
...
- RIGHT= 25
*/
static KRML_MUSTINLINE __m256i libcrux_sha3_simd_avx2_rotate_left_25(__m256i x)
{
  return
...
- RIGHT= 25
*/
static KRML_MUSTINLINE __m256i libcrux_sha3_simd_avx2__vxarq_u64_25(__m256i a, __m256i b)
{
  __m256i ab = mm256_xor_si256(a, b);
...
- RIGHT= 56
*/
static KRML_MUSTINLINE __m256i libcrux_sha3_simd_avx2_rotate_left_af(__m256i x)
{
  return
...
- RIGHT= 56
*/
static KRML_MUSTINLINE __m256i libcrux_sha3_simd_avx2__vxarq_u64_af(__m256i a, __m256i b)
{
  __m256i ab = mm256_xor_si256(a, b);
...
- RIGHT= 50
*/
static KRML_MUSTINLINE __m256i libcrux_sha3_simd_avx2_rotate_left_fd(__m256i x)
{
  return
...
- RIGHT= 50
*/
static KRML_MUSTINLINE __m256i libcrux_sha3_simd_avx2__vxarq_u64_fd(__m256i a, __m256i b)
{
  __m256i ab = mm256_xor_si256(a, b);
...
- N= 4
*/
static KRML_MUSTINLINE void libcrux_sha3_generic_keccak_pi_80_a6(Eurydice_arr_05 *self)
{
...
- N= 4
*/
static KRML_MUSTINLINE void libcrux_sha3_generic_keccak_chi_80_a6(Eurydice_arr_05 *self)
{
  Eurydice_arr_05 old = self[0U];
  KRML_MAYBE_FOR5(i0,
    (size_t)0U,
    ...
    if (uu____0.tag == core_option_None)
    {
      ...
      if (rem > (size_t)0U)
      {
        ...
        for (size_t i0 = (size_t)0U; i0 < chunks8; i0++)
        {
          ...
          mm256_storeu_si256_u8(uu____1, libcrux_sha3_traits_get_ij_a6(s, i, j)[0U]);
        ...
        if (rem8 > (size_t)0U)
        {
          ...
          mm256_storeu_si256_u8(uu____2, libcrux_sha3_traits_get_ij_a6(s, i, j)[0U]);
          Eurydice_slice_copy(Eurydice_slice_subslice_mut_7e(out0,
              (
                KRML_CLITERAL(core_ops_range_Range_08){

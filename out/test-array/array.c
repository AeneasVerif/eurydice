...
*/
/**
A monomorphic instance of array.mk_incr2.call_mut_fc
with const generics
- K= 10
*/
...
*/
/**
A monomorphic instance of array.mk_incr2.call_once_ea
with const generics
- K= 10
*/
uint32_t array_mk_incr2_call_once_ea_55(const uint32_t *_, size_t _0)
{
  return array_mk_incr2_call_mut_fc_55(&_, _0);
}
...
Eurydice_arr_6c array_mk_incr2_55(void)
{
  ...
  KRML_MAYBE_FOR10(i,
    ...
    arr_struct.data[i] = array_mk_incr2_call_mut_fc_55(&lvalue, i););
  return arr_struct;
}
...
*/
/**
A monomorphic instance of array.mk_incr.call_mut_ec
with const generics
- K= 10
*/
uint32_t array_mk_incr_call_mut_ec_55(void **_, size_t tupled_args)
{
  size_t i = tupled_args;
  return (uint32_t)i;
}
...
*/
/**
A monomorphic instance of array.mk_incr.call_once_4a
with const generics
- K= 10
*/
uint32_t array_mk_incr_call_once_4a_55(size_t _)
{
  /* original Rust expression is not an lvalue in C */
  void *lvalue = (void *)0U;
  return array_mk_incr_call_mut_ec_55(&lvalue, _);
}
...
Eurydice_arr_6c array_mk_incr_55(void)
{
  ...
  KRML_MAYBE_FOR10(i,
    ...
    /* original Rust expression is not an lvalue in C */
    void *lvalue = (void *)0U;
    arr_struct.data[i] = array_mk_incr_call_mut_ec_55(&lvalue, i););
  return arr_struct;
}
...
*/
/**
A monomorphic instance of array.nested_from_fn.closure.call_mut_87
with const generics
- K= 4
*/
...
*/
/**
A monomorphic instance of array.nested_from_fn.closure.call_once_81
with const generics
- K= 4
*/
size_t array_nested_from_fn_closure_call_once_81_23(const size_t *_, size_t _0)
{
  return array_nested_from_fn_closure_call_mut_87_23(&_, _0);
}
...
*/
/**
A monomorphic instance of array.nested_from_fn.call_mut_03
with const generics
- K= 4
*/
Eurydice_arr_cc array_nested_from_fn_call_mut_03_23(void **_, size_t tupled_args)
{
  ...
  KRML_MAYBE_FOR4(i,
    ...
    arr_struct.data[i] = array_nested_from_fn_closure_call_mut_87_23(&lvalue, i););
  return arr_struct;
}
...
*/
/**
A monomorphic instance of array.nested_from_fn.call_once_ed
with const generics
- K= 4
*/
Eurydice_arr_cc array_nested_from_fn_call_once_ed_23(size_t _)
{
  /* original Rust expression is not an lvalue in C */
  void *lvalue = (void *)0U;
  return array_nested_from_fn_call_mut_03_23(&lvalue, _);
}
...
Eurydice_arr_89 array_nested_from_fn_23(void)
{
  ...
  KRML_MAYBE_FOR4(i,
    ...
    /* original Rust expression is not an lvalue in C */
    void *lvalue = (void *)0U;
    arr_struct.data[i] = array_nested_from_fn_call_mut_03_23(&lvalue, i););
  return arr_struct;
}
...
*/
/**
A monomorphic instance of array.plus_one.call_mut_be
with const generics
- K= 1
*/
uint16_t array_plus_one_call_mut_be_6c(void **_, uint32_t tupled_args)
{
...
*/
/**
A monomorphic instance of array.plus_one.call_once_bd
with const generics
- K= 1
*/
uint16_t array_plus_one_call_once_bd_6c(uint32_t _)
{
  /* original Rust expression is not an lvalue in C */
  void *lvalue = (void *)0U;
  return array_plus_one_call_mut_be_6c(&lvalue, _);
}
...
Eurydice_arr_96 array_plus_one_6c(Eurydice_arr_d5 x)
{
  Eurydice_arr_96 arr_mapped_str;
  {
    /* original Rust expression is not an lvalue in C */
    void *lvalue = (void *)0U;
    arr_mapped_str.data[0U] = array_plus_one_call_mut_be_6c(&lvalue, x.data[0U]);
  }

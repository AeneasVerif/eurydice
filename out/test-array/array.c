...
void array_main(void)
{
  ...
  /* original Rust expression is not an lvalue in C */
  uint16_t lvalue1 = 1U;
  const_uint16_t__x2 uu____7 = { .fst = a1, .snd = &lvalue1 };
  ...
  const_size_t__x2 uu____8 = { .fst = &a2[3U][3U], .snd = &lvalue };

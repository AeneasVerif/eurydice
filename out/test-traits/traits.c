...
*/
uint32_t traits_to_int_88(Eurydice_dst_ref_mut_e2 *self)
{
  uint32_t
  uu____0 = traits_to_int_ac(&Eurydice_slice_index_mut(self[0U], (size_t)0U, traits_Foo));
  return uu____0 * traits_to_int_ac(&Eurydice_slice_index_mut(self[0U], (size_t)1U, traits_Foo));
}
...
- N= 2
*/
static Eurydice_dst_ref_mut_e2
array_to_subslice_mut_91(Eurydice_arr_e2 *a, core_ops_range_Range_08 r)
{
  return
    (KRML_CLITERAL(Eurydice_dst_ref_mut_e2){ .ptr = a->data + r.start, .meta = r.end - r.start });
}
...
void traits_main(void)
{
  ...
  Eurydice_dst_ref_mut_e2
  lvalue =
    array_to_subslice_mut_91(&foos,

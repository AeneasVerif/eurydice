...
/**
This function found in impl {where_clauses_simple::Ops<(1usize : usize)> for u64}
*/
uint64_t where_clauses_simple_add_8a(Eurydice_arr_2e x, uint64_t y)
{
...
This function found in impl {where_clauses_simple::Ops<(1usize : usize)> for u64}
*/
uint64_t where_clauses_simple_of_u16_8a(uint16_t x)
{
  return (uint64_t)x;
}
...
{
  uint64_t x = where_clauses_simple_of_u16_8a(0U);
  return where_clauses_simple_add_8a((KRML_CLITERAL(Eurydice_arr_2e){ .data = { 0U } }), x);
}
...
*/
uint64_t where_clauses_simple_fn_1_5f(void)
{
  uint64_t x = where_clauses_simple_of_u16_8a(0U);
  return where_clauses_simple_add_8a((KRML_CLITERAL(Eurydice_arr_2e){ .data = { 0U } }), x);
}
...
{
  uint64_t r = where_clauses_simple_fn_1_5f();
  uint64_t r_expected = 0ULL;
  const_uint64_t__x2 uu____0 = { .fst = &r, .snd = &r_expected };
  EURYDICE_ASSERT(uu____0.fst[0U] == uu____0.snd[0U], "panic!");
}
...
*/
tuple_65 where_clauses_simple_double_e7(uint64_t x, size_t y)
{
  uint64_t
  uu____0 = where_clauses_simple_add_8a((KRML_CLITERAL(Eurydice_arr_2e){ .data = { 0U } }), x);
  return
    (
  ...
  return
    (
      KRML_CLITERAL(tuple_b6){
        .fst = uu____0,
        .snd = where_clauses_simple_add_8a((KRML_CLITERAL(Eurydice_arr_2e){ .data = { 0U } }), y)
      }
    );
}
...
void where_clauses_simple_main(void)
{
  ...
  tuple_65 x = where_clauses_simple_double_e7(1ULL, (size_t)1U);

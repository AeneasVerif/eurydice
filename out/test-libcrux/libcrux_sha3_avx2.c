...
load_block_5b(Eurydice_arr_05 *state, Eurydice_arr_66 *blocks, size_t offset)
{
  for (size_t i = (size_t)0U; i < (size_t)136U / (size_t)32U; i++)
  {
    ...
    __m256i
    v00 =
      mm256_loadu_si256_u8(Eurydice_slice_subslice3(blocks->data[0U],
          start,
          start + (size_t)32U,
          Eurydice_dst_ref_87));
    __m256i
    v10 =
      mm256_loadu_si256_u8(Eurydice_slice_subslice3(blocks->data[1U],
          start,
          start + (size_t)32U,
          Eurydice_dst_ref_87));
    __m256i
    v20 =
      mm256_loadu_si256_u8(Eurydice_slice_subslice3(blocks->data[2U],
          start,
          start + (size_t)32U,
          Eurydice_dst_ref_87));
    __m256i
    v30 =
      mm256_loadu_si256_u8(Eurydice_slice_subslice3(blocks->data[3U],
          start,
          start + (size_t)32U,
          Eurydice_dst_ref_87));
  ...
  Eurydice_slice_copy(Eurydice_array_to_subslice3(&u8s,
      (size_t)0U,
      (size_t)8U,
      Eurydice_dst_ref_87),
    Eurydice_slice_subslice3(blocks->data[0U], start, start + (size_t)8U, Eurydice_dst_ref_87),
    uint8_t);
  Eurydice_slice_copy(Eurydice_array_to_subslice3(&u8s,
      (size_t)8U,
      (size_t)16U,
      Eurydice_dst_ref_87),
    Eurydice_slice_subslice3(blocks->data[1U], start, start + (size_t)8U, Eurydice_dst_ref_87),
    uint8_t);
  Eurydice_slice_copy(Eurydice_array_to_subslice3(&u8s,
      (size_t)16U,
      (size_t)24U,
      Eurydice_dst_ref_87),
    Eurydice_slice_subslice3(blocks->data[2U], start, start + (size_t)8U, Eurydice_dst_ref_87),
    uint8_t);
  Eurydice_slice_copy(Eurydice_array_to_subslice3(&u8s,
      (size_t)24U,
      (size_t)32U,
      Eurydice_dst_ref_87),
    Eurydice_slice_subslice3(blocks->data[3U], start, start + (size_t)8U, Eurydice_dst_ref_87),
    uint8_t);
  __m256i
  u =
  ...
  if (rem == (size_t)16U)
  {
    ...
    Eurydice_slice_copy(Eurydice_array_to_subslice3(&u8s0,
        (size_t)0U,
        (size_t)8U,
        Eurydice_dst_ref_87),
      Eurydice_slice_subslice3(blocks->data[0U],
        start + (size_t)8U,
        start + (size_t)16U,
        Eurydice_dst_ref_87),
      uint8_t);
    Eurydice_slice_copy(Eurydice_array_to_subslice3(&u8s0,
        ...
        (size_t)16U,
        Eurydice_dst_ref_87),
      Eurydice_slice_subslice3(blocks->data[1U],
        start + (size_t)8U,
        start + (size_t)16U,
        Eurydice_dst_ref_87),
      uint8_t);
    Eurydice_slice_copy(Eurydice_array_to_subslice3(&u8s0,
        ...
        (size_t)24U,
        Eurydice_dst_ref_87),
      Eurydice_slice_subslice3(blocks->data[2U],
        start + (size_t)8U,
        start + (size_t)16U,
        Eurydice_dst_ref_87),
      uint8_t);
    Eurydice_slice_copy(Eurydice_array_to_subslice3(&u8s0,
        ...
        (size_t)32U,
        Eurydice_dst_ref_87),
      Eurydice_slice_subslice3(blocks->data[3U],
        start + (size_t)8U,
        start + (size_t)16U,
        Eurydice_dst_ref_87),
      uint8_t);
...
- RATE= 136
*/
static void load_block_8f_5b(Eurydice_arr_05 *self, Eurydice_arr_66 *input, size_t start)
{
...
*/
static KRML_MUSTINLINE void
absorb_block_80_97(Eurydice_arr_05 *self, Eurydice_arr_66 *blocks, size_t start)
{
...
*/
static KRML_MUSTINLINE void
load_last_ad(Eurydice_arr_05 *state, Eurydice_arr_66 *blocks, size_t start, size_t len)
{
  Eurydice_arr_91
  buffers =
  ...
  KRML_MAYBE_FOR4(i,
    ...
    Eurydice_slice_copy(Eurydice_array_to_subslice3(&buffers.data[i0],
        ...
        len,
        Eurydice_dst_ref_87),
      Eurydice_slice_subslice3(blocks->data[i0], start, start + len, Eurydice_dst_ref_87),
      uint8_t);
  ...
  lvalue =
    {
      .data = {
        Eurydice_array_to_slice_d4(buffers.data),
...
*/
static void
load_last_8f_ad(Eurydice_arr_05 *self, Eurydice_arr_66 *input, size_t start, size_t len)
{
...
*/
static KRML_MUSTINLINE void
absorb_final_80_fb(Eurydice_arr_05 *self, Eurydice_arr_66 *last, size_t start, size_t len)
{
...
store_block_5b(
  ...
  Eurydice_dst_ref_87 out1,
  Eurydice_dst_ref_87 out2,
  Eurydice_dst_ref_87 out3,
  size_t start,
  size_t len
)
{
  ...
  if (rem > (size_t)0U)
  {
    ...
    for (size_t i0 = (size_t)0U; i0 < chunks8; i0++)
    {
      ...
      Eurydice_slice_copy(Eurydice_slice_subslice3(out0,
          ...
          Eurydice_dst_ref_87),
        Eurydice_array_to_subslice3(&u8s, (size_t)0U, (size_t)8U, Eurydice_dst_ref_87),
        uint8_t);
      Eurydice_slice_copy(Eurydice_slice_subslice3(out1,
          start0 + (size_t)8U * k,
          start0 + (size_t)8U * (k + (size_t)1U),
          Eurydice_dst_ref_87),
        Eurydice_array_to_subslice3(&u8s, (size_t)8U, (size_t)16U, Eurydice_dst_ref_87),
        uint8_t);
      Eurydice_slice_copy(Eurydice_slice_subslice3(out2,
          start0 + (size_t)8U * k,
          start0 + (size_t)8U * (k + (size_t)1U),
          Eurydice_dst_ref_87),
        Eurydice_array_to_subslice3(&u8s, (size_t)16U, (size_t)24U, Eurydice_dst_ref_87),
        uint8_t);
      Eurydice_slice_copy(Eurydice_slice_subslice3(out3,
          start0 + (size_t)8U * k,
          start0 + (size_t)8U * (k + (size_t)1U),
          Eurydice_dst_ref_87),
        Eurydice_array_to_subslice3(&u8s, (size_t)24U, (size_t)32U, Eurydice_dst_ref_87),
        uint8_t);
    }
    ...
    if (rem8 > (size_t)0U)
    {
      ...
      Eurydice_slice_copy(Eurydice_slice_subslice3(out0,
          ...
          start0 + len,
          Eurydice_dst_ref_87),
        Eurydice_array_to_subslice3(&u8s, (size_t)0U, rem, Eurydice_dst_ref_87),
        uint8_t);
      Eurydice_slice_copy(Eurydice_slice_subslice3(out1,
          start0 + len - rem8,
          start0 + len,
          Eurydice_dst_ref_87),
        Eurydice_array_to_subslice3(&u8s, (size_t)8U, (size_t)8U + rem, Eurydice_dst_ref_87),
        uint8_t);
      Eurydice_slice_copy(Eurydice_slice_subslice3(out2,
          start0 + len - rem8,
          start0 + len,
          Eurydice_dst_ref_87),
        Eurydice_array_to_subslice3(&u8s, (size_t)16U, (size_t)16U + rem, Eurydice_dst_ref_87),
        uint8_t);
      Eurydice_slice_copy(Eurydice_slice_subslice3(out3,
          start0 + len - rem8,
          start0 + len,
          Eurydice_dst_ref_87),
        Eurydice_array_to_subslice3(&u8s, (size_t)24U, (size_t)24U + rem, Eurydice_dst_ref_87),
        uint8_t);
    }
  }
}
...
*/
static KRML_MUSTINLINE void
load_block_3a(Eurydice_arr_05 *state, Eurydice_arr_66 *blocks, size_t offset)
{
...
*/
static KRML_MUSTINLINE void
load_last_c6(Eurydice_arr_05 *state, Eurydice_arr_66 *blocks, size_t start, size_t len)
{
  Eurydice_arr_a6
  buffers =
    { .data = { { .data = { 0U } }, { .data = { 0U } }, { .data = { 0U } }, { .data = { 0U } } } };
  ...
  lvalue =
    {
      .data = {
        Eurydice_array_to_slice_7b(buffers.data),
...
*/
static void
load_last_8f_c6(Eurydice_arr_05 *self, Eurydice_arr_66 *input, size_t start, size_t len)
{
...
*/
static KRML_MUSTINLINE void
absorb_final_80_fb0(Eurydice_arr_05 *self, Eurydice_arr_66 *last, size_t start, size_t len)
{
...
libcrux_sha3_avx2_x4_incremental_shake128_absorb_final(
  ...
  Eurydice_dst_ref_87 data1,
  Eurydice_dst_ref_87 data2,
  Eurydice_dst_ref_87 data3
)
{

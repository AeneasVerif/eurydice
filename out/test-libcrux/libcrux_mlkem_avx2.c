...
KRML_MUSTINLINE Eurydice_arr_60 libcrux_ml_kem_hash_functions_avx2_H(Eurydice_slice input)
{
...
)
{
  ...
  __m128i
  lower_shuffles0 =
    mm_loadu_si128(Eurydice_array_to_slice((size_t)16U, &lower_shuffles, uint8_t));
  ...
  __m128i
  upper_shuffles0 =
    mm_loadu_si128(Eurydice_array_to_slice((size_t)16U, &upper_shuffles, uint8_t));
  __m128i
...
sample_matrix_A_6c1(Eurydice_arr_aa0 *A_transpose, Eurydice_arr_48 *seed, bool transpose)
{
  KRML_MAYBE_FOR3(i0,
    ...
    (size_t
      i = (size_t)0U;
      i <
        Eurydice_slice_len(Eurydice_array_to_slice((size_t)3U, &sampled, Eurydice_arr_51),
          Eurydice_arr_51);
      i++)
    {
      size_t j = i;
...
- K= 3
*/
static KRML_MUSTINLINE void serialize_vector_ab(Eurydice_arr_260 *key, Eurydice_slice out)
{
  for
  (size_t
    i = (size_t)0U;
    i <
      Eurydice_slice_len(Eurydice_array_to_slice((size_t)3U, key, Eurydice_arr_51),
        Eurydice_arr_51);
    i++)
  {
    size_t i0 = i;
...
)
{
  ...
  serialize_vector_ab(private_key,
...
*/
static KRML_MUSTINLINE void
deserialize_vector_ab(Eurydice_slice secret_key, Eurydice_arr_260 *secret_as_ntt)
{
  KRML_MAYBE_FOR3(i,
    (size_t)0U,
    (size_t)3U,
...
- K= 3
*/
static KRML_MUSTINLINE libcrux_sha3_Sha3_512Digest G_41_e0(Eurydice_slice input)
{
...
static KRML_MUSTINLINE Eurydice_arr_db PRFxN_41(Eurydice_arr_46 *input)
{
  ...
  libcrux_sha3_avx2_x4_shake256(Eurydice_array_to_slice((size_t)33U, input->data, uint8_t),
...
add_to_ring_element_ab(Eurydice_arr_51 *myself, Eurydice_arr_51 *rhs)
{
  ...
  (size_t
    i = (size_t)0U;
    i < Eurydice_slice_len(Eurydice_array_to_slice((size_t)16U, myself, __m256i), __m256i);
    i++)
  {
    size_t i0 = i;
...
)
{
  ...
  (size_t
    i = (size_t)0U;
    i <
      Eurydice_slice_len(Eurydice_array_to_slice((size_t)3U, matrix_A, Eurydice_arr_260),
        Eurydice_arr_260);
    i++)
  {
    size_t i0 = i;
    ...
    (size_t
      i1 = (size_t)0U;
      i1 <
        Eurydice_slice_len(Eurydice_array_to_slice((size_t)3U, row, Eurydice_arr_51),
          Eurydice_arr_51);
      i1++)
    {
      size_t j = i1;
...
encaps_prepare_be(Eurydice_slice randomness, Eurydice_slice pk_hash)
{
...
)
{
  ...
  (size_t
    i0 = (size_t)0U;
    i0 <
      Eurydice_slice_len(Eurydice_array_to_slice((size_t)3U, a_as_ntt, Eurydice_arr_260),
        Eurydice_arr_260);
    i0++)
  {
    size_t i1 = i0;
...
*/
static KRML_MUSTINLINE void
compress_then_serialize_u_8c(Eurydice_arr_260 input, Eurydice_slice out)
{
  for
  (size_t
    i = (size_t)0U;
    i <
      Eurydice_slice_len(Eurydice_array_to_slice((size_t)3U, &input, Eurydice_arr_51),
        Eurydice_arr_51);
    i++)
  {
    size_t i0 = i;
...
encrypt_c1_481(Eurydice_slice randomness, Eurydice_arr_aa0 *matrix, Eurydice_slice ciphertext)
{
  ...
  Eurydice_arr_d1
  prf_output = PRF_41_410(Eurydice_array_to_slice((size_t)33U, &prf_input, uint8_t));
  Eurydice_arr_51
  error_2 =
    sample_from_binomial_distribution_89(Eurydice_array_to_slice((size_t)128U,
        &prf_output,
...
*/
static KRML_MUSTINLINE void
compress_then_serialize_4_84(Eurydice_arr_51 re, Eurydice_slice serialized)
{
  for (size_t i = (size_t)0U; i < LIBCRUX_ML_KEM_POLYNOMIAL_VECTORS_IN_RING_ELEMENT; i++)
  {
    size_t i0 = i;
...
*/
static KRML_MUSTINLINE void
compress_then_serialize_5_84(Eurydice_arr_51 re, Eurydice_slice serialized)
{
  for (size_t i = (size_t)0U; i < LIBCRUX_ML_KEM_POLYNOMIAL_VECTORS_IN_RING_ELEMENT; i++)
  {
    size_t i0 = i;
...
*/
static KRML_MUSTINLINE void
compress_then_serialize_ring_element_v_ed(Eurydice_arr_51 re, Eurydice_slice out)
{
...
)
{
  ...
  hashed =
    encaps_prepare_be(Eurydice_array_to_slice((size_t)32U, randomness, uint8_t),
...
)
{
  ...
  Eurydice_slice_copy(uu____0,
    ...
    uint8_t);
  libcrux_sha3_Sha3_512Digest
  hashed = G_41_e0(Eurydice_array_to_slice((size_t)64U, &to_hash0, uint8_t));
  Eurydice_slice_uint8_t_x2
  uu____1 =
    Eurydice_slice_split_at(Eurydice_array_to_slice((size_t)64U, &hashed, uint8_t),
      LIBCRUX_ML_KEM_CONSTANTS_SHARED_SECRET_SIZE,
...
- K= 3
*/
static KRML_MUSTINLINE Eurydice_arr_60 entropy_preprocess_39_be(Eurydice_slice randomness)
{
...
*/
static KRML_MUSTINLINE Eurydice_arr_2c
encrypt_741(Eurydice_slice public_key, Eurydice_arr_60 *message, Eurydice_slice randomness)
{
  libcrux_ml_kem_ind_cpa_unpacked_IndCpaPublicKeyUnpacked_63
...
)
{
  ...
  libcrux_sha3_Sha3_512Digest
  hashed = G_41_e0(Eurydice_array_to_slice((size_t)64U, &to_hash, uint8_t));
  Eurydice_slice_uint8_t_x2
  uu____1 =
    Eurydice_slice_split_at(Eurydice_array_to_slice((size_t)64U, &hashed, uint8_t),
      LIBCRUX_ML_KEM_CONSTANTS_SHARED_SECRET_SIZE,
  ...
  return (KRML_CLITERAL(Eurydice_tuple_56){ .fst = uu____2, .snd = kdf_39_ae(shared_secret) });
}
...
*/
static KRML_MUSTINLINE Eurydice_arr_60
decrypt_2f(Eurydice_slice secret_key, Eurydice_arr_2c *ciphertext)
{
  Eurydice_arr_260 arr_struct;
  KRML_MAYBE_FOR3(i,
    (size_t)0U,
...
sample_matrix_A_6c0(Eurydice_arr_95 *A_transpose, Eurydice_arr_48 *seed, bool transpose)
{
  KRML_MAYBE_FOR4(i0,
    ...
    (size_t
      i = (size_t)0U;
      i <
        Eurydice_slice_len(Eurydice_array_to_slice((size_t)4U, &sampled, Eurydice_arr_51),
          Eurydice_arr_51);
      i++)
    {
      size_t j = i;
...
- K= 4
*/
static KRML_MUSTINLINE void serialize_vector_42(Eurydice_arr_4c *key, Eurydice_slice out)
{
  for
  (size_t
    i = (size_t)0U;
    i <
      Eurydice_slice_len(Eurydice_array_to_slice((size_t)4U, key, Eurydice_arr_51),
        Eurydice_arr_51);
    i++)
  {
    size_t i0 = i;
...
)
{
  ...
  serialize_vector_42(private_key,
...
*/
static KRML_MUSTINLINE void
deserialize_vector_42(Eurydice_slice secret_key, Eurydice_arr_4c *secret_as_ntt)
{
  KRML_MAYBE_FOR4(i,
    (size_t)0U,
    (size_t)4U,
...
- K= 4
*/
static KRML_MUSTINLINE libcrux_sha3_Sha3_512Digest G_41_ac(Eurydice_slice input)
{
  return libcrux_ml_kem_hash_functions_avx2_G(input);
}
...
)
{
  ...
  (size_t
    i = (size_t)0U;
    i <
      Eurydice_slice_len(Eurydice_array_to_slice((size_t)4U, matrix_A, Eurydice_arr_4c),
        Eurydice_arr_4c);
    i++)
  {
    size_t i0 = i;
    ...
    (size_t
      i1 = (size_t)0U;
      i1 <
        Eurydice_slice_len(Eurydice_array_to_slice((size_t)4U, row, Eurydice_arr_51),
          Eurydice_arr_51);
      i1++)
    {
      size_t j = i1;
...
*/
static libcrux_sha3_Sha3_512Digest
encaps_prepare_6a(Eurydice_slice randomness, Eurydice_slice pk_hash)
{
  libcrux_sha3_Sha3_512Digest to_hash = libcrux_ml_kem_utils_into_padded_array_24(randomness);
  Eurydice_slice_copy(Eurydice_array_to_subslice_from((size_t)64U,
      &to_hash,
...
)
{
  ...
  (size_t
    i0 = (size_t)0U;
    i0 <
      Eurydice_slice_len(Eurydice_array_to_slice((size_t)4U, a_as_ntt, Eurydice_arr_4c),
        Eurydice_arr_4c);
    i0++)
  {
    size_t i1 = i0;
...
*/
static KRML_MUSTINLINE void
compress_then_serialize_u_c9(Eurydice_arr_4c input, Eurydice_slice out)
{
  for
  (size_t
    i = (size_t)0U;
    i <
      Eurydice_slice_len(Eurydice_array_to_slice((size_t)4U, &input, Eurydice_arr_51),
        Eurydice_arr_51);
    i++)
  {
    size_t i0 = i;
...
encrypt_c1_480(Eurydice_slice randomness, Eurydice_arr_95 *matrix, Eurydice_slice ciphertext)
{
  Eurydice_arr_3e prf_input = libcrux_ml_kem_utils_into_padded_array_c8(randomness);
  ...
  prf_input.data[32U] = domain_separator;
  Eurydice_arr_d1
  prf_output = PRF_41_440(Eurydice_array_to_slice((size_t)33U, &prf_input, uint8_t));
  Eurydice_arr_51
  error_2 =
    sample_from_binomial_distribution_89(Eurydice_array_to_slice((size_t)128U,
        &prf_output,
...
*/
static KRML_MUSTINLINE void
compress_then_serialize_ring_element_v_1e(Eurydice_arr_51 re, Eurydice_slice out)
{
...
)
{
  libcrux_sha3_Sha3_512Digest
  hashed =
    encaps_prepare_6a(Eurydice_array_to_slice((size_t)32U, randomness, uint8_t),
      Eurydice_array_to_slice((size_t)32U, &public_key->public_key_hash, uint8_t));
  Eurydice_slice_uint8_t_x2
  uu____0 =
    Eurydice_slice_split_at(Eurydice_array_to_slice((size_t)64U, &hashed, uint8_t),
...
)
{
  ...
  Eurydice_slice_copy(uu____0,
    ...
    uint8_t);
  libcrux_sha3_Sha3_512Digest
  hashed = G_41_ac(Eurydice_array_to_slice((size_t)64U, &to_hash0, uint8_t));
  Eurydice_slice_uint8_t_x2
  uu____1 =
    Eurydice_slice_split_at(Eurydice_array_to_slice((size_t)64U, &hashed, uint8_t),
      LIBCRUX_ML_KEM_CONSTANTS_SHARED_SECRET_SIZE,
...
- K= 4
*/
static KRML_MUSTINLINE Eurydice_arr_60 entropy_preprocess_39_6a(Eurydice_slice randomness)
{
  Eurydice_arr_60 out = { .data = { 0U } };
  Eurydice_slice_copy(Eurydice_array_to_slice((size_t)32U, &out, uint8_t), randomness, uint8_t);
  return out;
...
*/
static KRML_MUSTINLINE Eurydice_arr_00
encrypt_740(Eurydice_slice public_key, Eurydice_arr_60 *message, Eurydice_slice randomness)
{
  libcrux_ml_kem_ind_cpa_unpacked_IndCpaPublicKeyUnpacked_39
...
)
{
  ...
  Eurydice_slice_copy(uu____0, Eurydice_array_to_slice((size_t)32U, &lvalue, uint8_t), uint8_t);
  libcrux_sha3_Sha3_512Digest
  hashed = G_41_ac(Eurydice_array_to_slice((size_t)64U, &to_hash, uint8_t));
  Eurydice_slice_uint8_t_x2
  uu____1 =
    Eurydice_slice_split_at(Eurydice_array_to_slice((size_t)64U, &hashed, uint8_t),
      LIBCRUX_ML_KEM_CONSTANTS_SHARED_SECRET_SIZE,
  ...
  return (KRML_CLITERAL(Eurydice_tuple_2b){ .fst = uu____2, .snd = kdf_39_5e(shared_secret) });
}
...
*/
static KRML_MUSTINLINE Eurydice_arr_60
decrypt_37(Eurydice_slice secret_key, Eurydice_arr_00 *ciphertext)
{
  Eurydice_arr_4c arr_struct;
  KRML_MAYBE_FOR4(i,
    (size_t)0U,
...
- K= 2
*/
static KRML_MUSTINLINE Eurydice_arr_05 shake128_init_absorb_final_fd(Eurydice_arr_340 *input)
{
  Eurydice_arr_05 state = libcrux_sha3_avx2_x4_incremental_init();
  libcrux_sha3_avx2_x4_incremental_shake128_absorb_final(&state,
    Eurydice_array_to_slice((size_t)34U, input->data, uint8_t),
...
- K= 2
*/
static KRML_MUSTINLINE Eurydice_arr_36 sample_from_xof_6c(Eurydice_arr_340 *seeds)
{
...
sample_matrix_A_6c(Eurydice_arr_e20 *A_transpose, Eurydice_arr_48 *seed, bool transpose)
{
  KRML_MAYBE_FOR2(i0,
    ...
    (size_t
      i = (size_t)0U;
      i <
        Eurydice_slice_len(Eurydice_array_to_slice((size_t)2U, &sampled, Eurydice_arr_51),
          Eurydice_arr_51);
      i++)
    {
      size_t j = i;
...
- K= 2
*/
static KRML_MUSTINLINE void serialize_vector_89(Eurydice_arr_36 *key, Eurydice_slice out)
{
  for
  (size_t
    i = (size_t)0U;
    i <
      Eurydice_slice_len(Eurydice_array_to_slice((size_t)2U, key, Eurydice_arr_51),
        Eurydice_arr_51);
    i++)
  {
    size_t i0 = i;
...
)
{
  ...
  serialize_vector_89(private_key,
...
*/
static KRML_MUSTINLINE void
deserialize_vector_89(Eurydice_slice secret_key, Eurydice_arr_36 *secret_as_ntt)
{
  KRML_MAYBE_FOR2(i,
    (size_t)0U,
    (size_t)2U,
...
- K= 2
*/
static KRML_MUSTINLINE Eurydice_arr_36 sample_from_xof_b3(Eurydice_arr_340 *seeds)
{
  Eurydice_arr_fb sampled_coefficients = { .data = { 0U } };
  Eurydice_arr_04 out = { .data = { { .data = { 0U } }, { .data = { 0U } } } };
  Eurydice_arr_73
...
- K= 2
*/
static KRML_MUSTINLINE libcrux_sha3_Sha3_512Digest G_41_fd(Eurydice_slice input)
{
  return libcrux_ml_kem_hash_functions_avx2_G(input);
}
...
)
{
  ...
  (size_t
    i = (size_t)0U;
    i <
      Eurydice_slice_len(Eurydice_array_to_slice((size_t)2U, matrix_A, Eurydice_arr_36),
        Eurydice_arr_36);
    i++)
  {
    size_t i0 = i;
    ...
    (size_t
      i1 = (size_t)0U;
      i1 <
        Eurydice_slice_len(Eurydice_array_to_slice((size_t)2U, row, Eurydice_arr_51),
          Eurydice_arr_51);
      i1++)
    {
      size_t j = i1;
...
*/
static libcrux_sha3_Sha3_512Digest
encaps_prepare_f8(Eurydice_slice randomness, Eurydice_slice pk_hash)
{
  libcrux_sha3_Sha3_512Digest to_hash = libcrux_ml_kem_utils_into_padded_array_24(randomness);
  Eurydice_slice_copy(Eurydice_array_to_subslice_from((size_t)64U,
      &to_hash,
...
)
{
  ...
  (size_t
    i0 = (size_t)0U;
    i0 <
      Eurydice_slice_len(Eurydice_array_to_slice((size_t)2U, a_as_ntt, Eurydice_arr_36),
        Eurydice_arr_36);
    i0++)
  {
    size_t i1 = i0;
...
*/
static KRML_MUSTINLINE void
compress_then_serialize_u_2d(Eurydice_arr_36 input, Eurydice_slice out)
{
  for
  (size_t
    i = (size_t)0U;
    i <
      Eurydice_slice_len(Eurydice_array_to_slice((size_t)2U, &input, Eurydice_arr_51),
        Eurydice_arr_51);
    i++)
  {
    size_t i0 = i;
...
encrypt_c1_48(Eurydice_slice randomness, Eurydice_arr_e20 *matrix, Eurydice_slice ciphertext)
{
  Eurydice_arr_3e prf_input = libcrux_ml_kem_utils_into_padded_array_c8(randomness);
  ...
  prf_input.data[32U] = domain_separator;
  Eurydice_arr_d1
  prf_output = PRF_41_490(Eurydice_array_to_slice((size_t)33U, &prf_input, uint8_t));
  Eurydice_arr_51
  error_2 =
    sample_from_binomial_distribution_89(Eurydice_array_to_slice((size_t)128U,
        &prf_output,
...
*/
static KRML_MUSTINLINE void
compress_then_serialize_ring_element_v_ba(Eurydice_arr_51 re, Eurydice_slice out)
{
  compress_then_serialize_4_84(re, out);
}
...
)
{
  libcrux_sha3_Sha3_512Digest
  hashed =
    encaps_prepare_f8(Eurydice_array_to_slice((size_t)32U, randomness, uint8_t),
      Eurydice_array_to_slice((size_t)32U, &public_key->public_key_hash, uint8_t));
  Eurydice_slice_uint8_t_x2
  uu____0 =
    Eurydice_slice_split_at(Eurydice_array_to_slice((size_t)64U, &hashed, uint8_t),
...
)
{
  ...
  Eurydice_slice_copy(uu____0,
    ...
    uint8_t);
  libcrux_sha3_Sha3_512Digest
  hashed = G_41_fd(Eurydice_array_to_slice((size_t)64U, &to_hash0, uint8_t));
  Eurydice_slice_uint8_t_x2
  uu____1 =
    Eurydice_slice_split_at(Eurydice_array_to_slice((size_t)64U, &hashed, uint8_t),
      LIBCRUX_ML_KEM_CONSTANTS_SHARED_SECRET_SIZE,
...
libcrux_ml_kem_ind_cca_generate_keypair_bb(libcrux_sha3_Sha3_512Digest *randomness)
{
  ...
  Eurydice_arr_7f
  secret_key_serialized =
    serialize_kem_secret_key_4d(Eurydice_array_to_slice((size_t)768U,
        &ind_cpa_private_key,
        uint8_t),
...
- K= 2
*/
static KRML_MUSTINLINE Eurydice_arr_60 entropy_preprocess_39_f8(Eurydice_slice randomness)
{
  Eurydice_arr_60 out = { .data = { 0U } };
  Eurydice_slice_copy(Eurydice_array_to_slice((size_t)32U, &out, uint8_t), randomness, uint8_t);
  return out;
...
*/
static KRML_MUSTINLINE Eurydice_arr_56
encrypt_74(Eurydice_slice public_key, Eurydice_arr_60 *message, Eurydice_slice randomness)
{
  libcrux_ml_kem_ind_cpa_unpacked_IndCpaPublicKeyUnpacked_94
...
libcrux_ml_kem_ind_cca_encapsulate_70(Eurydice_arr_30 *public_key, Eurydice_arr_60 *randomness)
{
  ...
  Eurydice_slice_copy(uu____0, Eurydice_array_to_slice((size_t)32U, &lvalue, uint8_t), uint8_t);
  libcrux_sha3_Sha3_512Digest
  hashed = G_41_fd(Eurydice_array_to_slice((size_t)64U, &to_hash, uint8_t));
  Eurydice_slice_uint8_t_x2
  uu____1 =
    Eurydice_slice_split_at(Eurydice_array_to_slice((size_t)64U, &hashed, uint8_t),
      LIBCRUX_ML_KEM_CONSTANTS_SHARED_SECRET_SIZE,
  ...
  return (KRML_CLITERAL(Eurydice_tuple_17){ .fst = uu____2, .snd = kdf_39_4d(shared_secret) });
}
...
*/
static KRML_MUSTINLINE Eurydice_arr_60
decrypt_4b(Eurydice_slice secret_key, Eurydice_arr_56 *ciphertext)
{
  Eurydice_arr_36 arr_struct;
  KRML_MAYBE_FOR2(i,
    (size_t)0U,

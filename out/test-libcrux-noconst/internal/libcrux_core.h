...
- $4size_t
*/
typedef struct Eurydice_arr_65_s { Eurydice_arr_3e0 data[4U]; } Eurydice_arr_65;
...
typedef struct Eurydice_dst_ref_mut_uint8_t_size_t_x4_s
{
...
- $3size_t
*/
typedef struct Eurydice_arr_46_s { Eurydice_arr_3e0 data[3U]; } Eurydice_arr_46;
...
- $2size_t
*/
typedef struct Eurydice_arr_cf_s { Eurydice_arr_3e0 data[2U]; } Eurydice_arr_cf;
...
- $4size_t
*/
typedef struct Eurydice_arr_1c_s { Eurydice_mut_borrow_slice_u8 data[4U]; } Eurydice_arr_1c;

...
- $256size_t
*/
typedef struct Eurydice_arr_ef_s { Eurydice_arr_88 data[256U]; } Eurydice_arr_ef;
...
- $1size_t
*/
typedef struct Eurydice_arr_3e_s { Eurydice_mut_borrow_slice_u8 data[1U]; } Eurydice_arr_3e;

...
load_block_5b(Eurydice_arr_05 *state, Eurydice_arr_1c *blocks, size_t offset)
{
...
- RATE= 136
*/
static void load_block_8f_5b(Eurydice_arr_05 *self, Eurydice_arr_1c *input, size_t start)
{
...
*/
static KRML_MUSTINLINE void
absorb_block_80_97(Eurydice_arr_05 *self, Eurydice_arr_1c *blocks, size_t start)
{
...
*/
static KRML_MUSTINLINE void
load_last_ad(Eurydice_arr_05 *state, Eurydice_arr_1c *blocks, size_t start, size_t len)
{
  Eurydice_arr_91
  buffers =
...
*/
static void
load_last_8f_ad(Eurydice_arr_05 *self, Eurydice_arr_1c *input, size_t start, size_t len)
{
...
*/
static KRML_MUSTINLINE void
absorb_final_80_fb(Eurydice_arr_05 *self, Eurydice_arr_1c *last, size_t start, size_t len)
{
  ...
  if (rem > (size_t)0U)
  {
    ...
    if (rem8 > (size_t)0U)
    {
      ...
      Eurydice_slice_copy(Eurydice_slice_subslice_mut_7e(out1,
        ...
        Eurydice_array_to_subslice_mut_365(&u8s,
          (KRML_CLITERAL(core_ops_range_Range_08){ .start = (size_t)8U, .end = (size_t)8U + rem })),
        uint8_t);
      Eurydice_slice_copy(Eurydice_slice_subslice_mut_7e(out2,
          (
            KRML_CLITERAL(core_ops_range_Range_08){
        ...
        Eurydice_array_to_subslice_mut_365(&u8s,
          (KRML_CLITERAL(core_ops_range_Range_08){ .start = (size_t)16U, .end = (size_t)16U + rem })),
        uint8_t);
      Eurydice_slice_copy(Eurydice_slice_subslice_mut_7e(out3,
          (
            KRML_CLITERAL(core_ops_range_Range_08){
        ...
        Eurydice_array_to_subslice_mut_365(&u8s,
          (KRML_CLITERAL(core_ops_range_Range_08){ .start = (size_t)24U, .end = (size_t)24U + rem })),
        uint8_t);
    }
  }
}
...
{
  /* original Rust expression is not an lvalue in C */
  Eurydice_arr_1c lvalue = { .data = { input0, input1, input2, input3 } };
...
*/
static KRML_MUSTINLINE void
load_block_3a(Eurydice_arr_05 *state, Eurydice_arr_1c *blocks, size_t offset)
{
...
*/
static KRML_MUSTINLINE void
load_last_c6(Eurydice_arr_05 *state, Eurydice_arr_1c *blocks, size_t start, size_t len)
{
  Eurydice_arr_a6
  buffers =
    { .data = { { .data = { 0U } }, { .data = { 0U } }, { .data = { 0U } }, { .data = { 0U } } } };
...
*/
static void
load_last_8f_c6(Eurydice_arr_05 *self, Eurydice_arr_1c *input, size_t start, size_t len)
{
...
*/
static KRML_MUSTINLINE void
absorb_final_80_fb0(Eurydice_arr_05 *self, Eurydice_arr_1c *last, size_t start, size_t len)
{
...
)
{
  ...
  /* original Rust expression is not an lvalue in C */
  Eurydice_arr_1c lvalue = { .data = { data0, data1, data2, data3 } };
  Eurydice_arr_1c *uu____1 = &lvalue;

...
- N= 4
*/
static Eurydice_dst_ref_mut_30 array_to_slice_mut_cf4(Eurydice_arr_0d *a)
{
  Eurydice_dst_ref_mut_30 lit;
  lit.ptr = a->data;
  lit.meta = (size_t)4U;
  return lit;
}
...
*/
static KRML_MUSTINLINE void
serialize_vector_d0(Eurydice_arr_0d *key, Eurydice_mut_borrow_slice_u8 out)
{
  for
  (size_t
    i = (size_t)0U;
...
serialize_public_key_ff(Eurydice_arr_0d *t_as_ntt, Eurydice_mut_borrow_slice_u8 seed_for_a)
{
...
*/
static KRML_MUSTINLINE void
deserialize_vector_d0(Eurydice_mut_borrow_slice_u8 secret_key, Eurydice_arr_0d *secret_as_ntt)
{
  KRML_MAYBE_FOR4(i,
    (size_t)0U,
    (size_t)4U,
...
- K= 4
*/
static inline libcrux_sha3_Sha3_512Digest G_4a_ac(Eurydice_mut_borrow_slice_u8 input)
{
...
- N= 4
*/
static Eurydice_dst_ref_mut_440 array_to_slice_mut_7c0(Eurydice_arr_950 *a)
{
  Eurydice_dst_ref_mut_440 lit;
  lit.ptr = a->data;
  lit.meta = (size_t)4U;
  return lit;
}
...
)
{
  ...
  (size_t
    i = (size_t)0U;
    i < Eurydice_slice_len(array_to_slice_mut_7c0(matrix_A), Eurydice_arr_0d);
    i++)
  {
    size_t i0 = i;
...
)
{
  ...
  (size_t
    i0 = (size_t)0U;
    i0 < Eurydice_slice_len(array_to_slice_mut_7c0(a_as_ntt), Eurydice_arr_0d);
    i0++)
  {
    size_t i1 = i0;
...
*/
static KRML_MUSTINLINE void
compress_then_serialize_u_2f(Eurydice_arr_0d input, Eurydice_mut_borrow_slice_u8 out)
{
  for
  (size_t
    i = (size_t)0U;
...
)
{
  ...
  Eurydice_slice_copy(uu____0,
    ...
    uint8_t);
  libcrux_sha3_Sha3_512Digest hashed = G_4a_ac(Eurydice_array_to_slice_mut_d8(&to_hash0));
  Eurydice_dst_ref_mut_uint8_t_size_t_x2
  uu____1 =
    Eurydice_slice_split_at(Eurydice_array_to_slice_mut_d8(&hashed),
      LIBCRUX_ML_KEM_CONSTANTS_SHARED_SECRET_SIZE,
...
)
{
  ...
  libcrux_sha3_Sha3_512Digest hashed = G_4a_ac(Eurydice_array_to_slice_mut_d8(&to_hash));
  Eurydice_dst_ref_mut_uint8_t_size_t_x2
  uu____1 =
    Eurydice_slice_split_at(Eurydice_array_to_slice_mut_d8(&hashed),
      LIBCRUX_ML_KEM_CONSTANTS_SHARED_SECRET_SIZE,
...
- N= 2
*/
static Eurydice_dst_ref_mut_30 array_to_slice_mut_cf1(Eurydice_arr_270 *a)
{
  Eurydice_dst_ref_mut_30 lit;
  lit.ptr = a->data;
  lit.meta = (size_t)2U;
...
*/
static KRML_MUSTINLINE void
sample_matrix_A_2b0(Eurydice_arr_e21 *A_transpose, Eurydice_arr_48 *seed, bool transpose)
{
  KRML_MAYBE_FOR2(i0,
    (size_t)0U,
    (size_t)2U,
...
*/
static KRML_MUSTINLINE void
serialize_vector_a0(Eurydice_arr_270 *key, Eurydice_mut_borrow_slice_u8 out)
{
  for
  (size_t
    i = (size_t)0U;
...
serialize_public_key_64(Eurydice_arr_270 *t_as_ntt, Eurydice_mut_borrow_slice_u8 seed_for_a)
{
...
*/
static KRML_MUSTINLINE void
deserialize_vector_a0(Eurydice_mut_borrow_slice_u8 secret_key, Eurydice_arr_270 *secret_as_ntt)
{
  KRML_MAYBE_FOR2(i,
    (size_t)0U,
    (size_t)2U,
...
- K= 2
*/
static inline libcrux_sha3_Sha3_512Digest G_4a_fd(Eurydice_mut_borrow_slice_u8 input)
{
  return libcrux_ml_kem_hash_functions_portable_G(input);
}
...
- N= 2
*/
static Eurydice_dst_ref_mut_ca0 array_to_slice_mut_f40(Eurydice_arr_e21 *a)
{
  Eurydice_dst_ref_mut_ca0 lit;
  lit.ptr = a->data;
  lit.meta = (size_t)2U;
  return lit;
}
...
)
{
  ...
  (size_t
    i = (size_t)0U;
    i < Eurydice_slice_len(array_to_slice_mut_f40(matrix_A), Eurydice_arr_270);
    i++)
  {
    size_t i0 = i;
...
)
{
  ...
  (size_t
    i0 = (size_t)0U;
    i0 < Eurydice_slice_len(array_to_slice_mut_f40(a_as_ntt), Eurydice_arr_270);
    i0++)
  {
    size_t i1 = i0;
...
*/
static KRML_MUSTINLINE void
compress_then_serialize_u_6d(Eurydice_arr_270 input, Eurydice_mut_borrow_slice_u8 out)
{
  for
  (size_t
    i = (size_t)0U;
...
)
{
  ...
  Eurydice_slice_copy(uu____0,
    Eurydice_array_to_slice_mut_6e(&key_pair->public_key.public_key_hash),
    uint8_t);
  libcrux_sha3_Sha3_512Digest hashed = G_4a_fd(Eurydice_array_to_slice_mut_d8(&to_hash0));
  Eurydice_dst_ref_mut_uint8_t_size_t_x2
  uu____1 =
    Eurydice_slice_split_at(Eurydice_array_to_slice_mut_d8(&hashed),
      LIBCRUX_ML_KEM_CONSTANTS_SHARED_SECRET_SIZE,
...
)
{
  ...
  lvalue =
    H_4a_fd(Eurydice_array_to_slice_mut_03(libcrux_ml_kem_types_as_slice_e6_4d(public_key)));
  Eurydice_slice_copy(uu____0, Eurydice_array_to_slice_mut_6e(&lvalue), uint8_t);
  libcrux_sha3_Sha3_512Digest hashed = G_4a_fd(Eurydice_array_to_slice_mut_d8(&to_hash));
  Eurydice_dst_ref_mut_uint8_t_size_t_x2
  uu____1 =
    Eurydice_slice_split_at(Eurydice_array_to_slice_mut_d8(&hashed),
      LIBCRUX_ML_KEM_CONSTANTS_SHARED_SECRET_SIZE,
...
- K= 3
*/
static KRML_MUSTINLINE Eurydice_arr_c40 sample_from_xof_2b(Eurydice_arr_84 *seeds)
{
...
- N= 3
*/
static Eurydice_dst_ref_mut_30 array_to_slice_mut_cf0(Eurydice_arr_c40 *a)
{
  Eurydice_dst_ref_mut_30 lit;
  lit.ptr = a->data;
  lit.meta = (size_t)3U;
...
*/
static KRML_MUSTINLINE void
serialize_vector_1b(Eurydice_arr_c40 *key, Eurydice_mut_borrow_slice_u8 out)
{
  for
  (size_t
    i = (size_t)0U;
...
serialize_public_key_89(Eurydice_arr_c40 *t_as_ntt, Eurydice_mut_borrow_slice_u8 seed_for_a)
{
...
*/
static KRML_MUSTINLINE void
deserialize_vector_1b(Eurydice_mut_borrow_slice_u8 secret_key, Eurydice_arr_c40 *secret_as_ntt)
{
  KRML_MAYBE_FOR3(i,
    (size_t)0U,
    (size_t)3U,
...
static libcrux_ml_kem_ind_cpa_unpacked_IndCpaPublicKeyUnpacked_a0 default_8b_1b(void)
{
  ...
  KRML_MAYBE_FOR3(i0,
    ...
    memcpy(lit.data, repeat_expression, (size_t)3U * sizeof (Eurydice_arr_b9));
    repeat_expression1[i0] = lit;);
  memcpy(lit0.A.data, repeat_expression1, (size_t)3U * sizeof (Eurydice_arr_c40));
  return lit0;
}
...
- K= 3
*/
static inline libcrux_sha3_Sha3_512Digest G_4a_e0(Eurydice_mut_borrow_slice_u8 input)
{
  return libcrux_ml_kem_hash_functions_portable_G(input);
}
...
- N= 3
*/
static Eurydice_dst_ref_mut_94 array_to_slice_mut_b5(Eurydice_arr_aa *a)
{
  Eurydice_dst_ref_mut_94 lit;
  lit.ptr = a->data;
  lit.meta = (size_t)3U;
  return lit;
}
...
compute_As_plus_e_1b(
  ...
  Eurydice_arr_c40 *s_as_ntt,
  Eurydice_arr_c40 *error_as_ntt
)
{
  for
  (size_t
    i = (size_t)0U;
    i < Eurydice_slice_len(array_to_slice_mut_b5(matrix_A), Eurydice_arr_c40);
    i++)
  {
    size_t i0 = i;
    Eurydice_arr_c40 *row = &matrix_A->data[i0];
    Eurydice_arr_b9 uu____0 = ZERO_d6_ea();
    t_as_ntt->data[i0] = uu____0;
    for
    (size_t
...
)
{
  ...
  (size_t
    i0 = (size_t)0U;
    i0 < Eurydice_slice_len(array_to_slice_mut_b5(a_as_ntt), Eurydice_arr_c40);
    i0++)
  {
    size_t i1 = i0;
    Eurydice_arr_c40 *row = &a_as_ntt->data[i1];
    for
    (size_t
      i = (size_t)0U;
...
*/
static KRML_MUSTINLINE void
compress_then_serialize_u_43(Eurydice_arr_c40 input, Eurydice_mut_borrow_slice_u8 out)
{
  for
  (size_t
    i = (size_t)0U;
...
compute_message_1b(
  Eurydice_arr_b9 *v,
  Eurydice_arr_c40 *secret_as_ntt,
...
*/
static KRML_MUSTINLINE Eurydice_arr_60
decrypt_unpacked_42(Eurydice_arr_c40 *secret_key, Eurydice_arr_2c *ciphertext)
{
...
)
{
  ...
  Eurydice_slice_copy(uu____0,
    Eurydice_array_to_slice_mut_6e(&key_pair->public_key.public_key_hash),
    uint8_t);
  libcrux_sha3_Sha3_512Digest hashed = G_4a_e0(Eurydice_array_to_slice_mut_d8(&to_hash0));
  Eurydice_dst_ref_mut_uint8_t_size_t_x2
  uu____1 =
    Eurydice_slice_split_at(Eurydice_array_to_slice_mut_d8(&hashed),
      LIBCRUX_ML_KEM_CONSTANTS_SHARED_SECRET_SIZE,
...
libcrux_ml_kem_ind_cca_encapsulate_ca(Eurydice_arr_74 *public_key, Eurydice_arr_60 *randomness)
{
  ...
  lvalue =
    H_4a_e0(Eurydice_array_to_slice_mut_45(libcrux_ml_kem_types_as_slice_e6_d0(public_key)));
  Eurydice_slice_copy(uu____0, Eurydice_array_to_slice_mut_6e(&lvalue), uint8_t);
  libcrux_sha3_Sha3_512Digest hashed = G_4a_e0(Eurydice_array_to_slice_mut_d8(&to_hash));
  Eurydice_dst_ref_mut_uint8_t_size_t_x2
  uu____1 =
    Eurydice_slice_split_at(Eurydice_array_to_slice_mut_d8(&hashed),
      LIBCRUX_ML_KEM_CONSTANTS_SHARED_SECRET_SIZE,

...
)
{
  ...
  for (size_t i = (size_t)0U; i < (size_t)72U / (size_t)8U; i++)
  {
    ...
    memcpy(arr.data,
      Eurydice_slice_subslice_mut_7e(blocks,
...
- N= 1
*/
KRML_MUSTINLINE Eurydice_arr_a5 libcrux_sha3_generic_keccak_theta_80_04(Eurydice_arr_26 *self)
{
  Eurydice_arr_a5
  c =
    {
...
libcrux_sha3_generic_keccak_rho_80_04(Eurydice_arr_26 *self, Eurydice_arr_a5 t)
{
  ...
  libcrux_sha3_generic_keccak_set_80_04(uu____0,
    (size_t)1U,
    (size_t)0U,
  ...
  libcrux_sha3_generic_keccak_set_80_04(uu____1,
    (size_t)2U,
    (size_t)0U,
  ...
  libcrux_sha3_generic_keccak_set_80_04(uu____2,
    (size_t)3U,
    (size_t)0U,
  ...
  libcrux_sha3_generic_keccak_set_80_04(uu____3,
    (size_t)4U,
    (size_t)0U,
...
)
{
  ...
  libcrux_sha3_simd_portable_load_block_f8(state,
    Eurydice_array_to_slice_mut_7d(&buffer),
    (size_t)0U);
}
...
)
{
  ...
  for (size_t i = (size_t)0U; i < octets; i++)
  {
    ...
    lvalue =
      core_num__u64__to_le_bytes(libcrux_sha3_traits_get_ij_04(s,
          i0 / (size_t)5U,
          i0 % (size_t)5U)[0U]);
    Eurydice_slice_copy(uu____0, Eurydice_array_to_slice_mut_41(&lvalue), uint8_t);
  }
  ...
  if (remaining > (size_t)0U)
  {
    ...
    Eurydice_slice_copy(uu____1,
      Eurydice_array_to_subslice_mut_360(&lvalue,
...
)
{
  ...
  for (size_t i = (size_t)0U; i < data_len / (size_t)72U; i++)
  {
    size_t i0 = i;
    /* original Rust expression is not an lvalue in C */
    Eurydice_arr_3e lvalue = { .data = { data } };
...
)
{
  ...
  libcrux_sha3_simd_portable_load_block_5b(state,
    Eurydice_array_to_slice_mut_d4(&buffer),
    (size_t)0U);
}
...
)
{
  ...
  libcrux_sha3_simd_portable_load_block_3a(state,
    Eurydice_array_to_slice_mut_7b(&buffer),
    (size_t)0U);
}
...
)
{
  ...
  /* original Rust expression is not an lvalue in C */
  Eurydice_arr_3e lvalue = { .data = { data0 } };
  Eurydice_arr_3e *uu____1 = &lvalue;
...
)
{
  ...
  libcrux_sha3_simd_portable_load_block_2c(state,
    Eurydice_array_to_slice_mut_d1(&buffer),
    (size_t)0U);
}
...
)
{
  ...
  Eurydice_slice_copy(Eurydice_array_to_subslice_mut_364(&buffer,
      (KRML_CLITERAL(core_ops_range_Range_08){ .start = (size_t)0U, .end = len })),
    Eurydice_slice_subslice_mut_7e(blocks,
      (KRML_CLITERAL(core_ops_range_Range_08){ .start = start, .end = start + len })),
    uint8_t);
  ...
  libcrux_sha3_simd_portable_load_block_7a(state,
    Eurydice_array_to_slice_mut_9c(&buffer),
    (size_t)0U);
}

...
- ETA2_RANDOMNESS_SIZE= 128
*/
static tuple_7f encapsulate_avx2_cd(Eurydice_arr_74 *public_key, Eurydice_arr_60 *randomness)
{
...
- ETA2_RANDOMNESS_SIZE= 128
*/
static tuple_7f encapsulate_cd(Eurydice_arr_74 *public_key, Eurydice_arr_60 *randomness)
{
